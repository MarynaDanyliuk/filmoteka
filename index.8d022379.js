 ...
 * limitations under the License.
 */
e(a)(e(y).mark((function t(){return e(y).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if(ye()){e.next=5;break}return Cr.warn(Pr.create("indexeddb-unavailable",{errorInfo:"IndexedDB is not available in this environment."}).message),e.abrupt("return",!1);case 5:return e.prev=5,e.next=8,me();case 8:e.next=14;break;case 10:return e.prev=10,e.t0=e.catch(5),Cr.warn(Pr.create("indexeddb-unavailable",{errorInfo:null===e.t0||void 0===e.t0?void 0:e.t0.toString()}).message),e.abrupt("return",!1);case 14:return e.abrupt("return",!0);case 15:case"end":return e.stop()}}),t,null,[[5,10]])})))).apply(this,arguments)}function si(){return(si=e(a)(e(y).mark((function t(n,r,i,a,o,s,u){var c,l,f,h,p,d,v;return e(y).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:return(l=Gr(n)).then((function(e){i[e.measurementId]=e.appId,n.options.measurementId&&e.measurementId!==n.options.measurementId&&Cr.warn("The measurement ID in the local Firebase config (".concat(n.options.measurementId,")")+" does not match the measurement ID fetched from the server (".concat(e.measurementId,").")+" To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.")})).catch((function(e){return Cr.error(e)})),r.push(l),f=ai().then((function(e){return e?a.getId():void 0})),t.t0=e(b),t.next=8,Promise.all([l,f]);case 8:return t.t1=t.sent,h=(0,t.t0)(t.t1,2),p=h[0],d=h[1],Vr(s)||Dr(s,p.measurementId),ei&&(o("consent","default",ei),ri(void 0)),o("js",new Date),(v=null!==(c=null==u?void 0:u.config)&&void 0!==c?c:{}).origin="firebase",v.update=!0,null!=d&&(v.firebase_id=d),o("config",p.measurementId,v),Zr&&(o("set",Zr),ii(void 0)),t.abrupt("return",p.measurementId);case 22:case"end":return t.stop()}}),t)})))).apply(this,arguments)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Tu={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},Su="_blank",Au="http://localhost",Ou=function(){"use strict";function t(n){e(s)(this,t),this.window=n,this.associatedEvent=null}return e(u)(t,[{key:"close",value:function(){if(this.window)try{this.window.close()}catch(e){}}}]),t}();function Cu(t,n,r){var i=arguments.length>3&&void 0!==arguments[3]?arguments[3]:500,a=arguments.length>4&&void 0!==arguments[4]?arguments[4]:600,o=Math.max((window.screen.availHeight-a)/2,0).toString(),s=Math.max((window.screen.availWidth-i)/2,0).toString(),u="",c=Object.assign(Object.assign({},Tu),{width:i.toString(),height:a.toString(),top:o,left:s}),l=ve().toLowerCase();r&&(u=za(l)?Su:r),Va(l)&&(n=n||Au,c.scrollbars="yes");var f=Object.entries(c).reduce((function(t,n){var r=e(b)(n,2),i=r[0],a=r[1];return"".concat(t).concat(i,"=").concat(a,",")}),"");if(Xa(l)&&"_self"!==u)return Ru(n||"",u),new Ou(null);var h=window.open(n||"",u,f);ji(h,t,"popup-blocked");try{h.focus()}catch(e){}return new Ou(h)}function Ru(e,t){var n=document.createElement("a");n.href=e,n.target=t;var r=document.createEvent("MouseEvent");r.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(r)}
/**
 * @license
 * Copyright 2021 Google LLC
 *

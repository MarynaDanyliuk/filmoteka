 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const be=[];var Ee,Ie;(Ie=Ee||(Ee={}))[Ie.DEBUG=0]="DEBUG",Ie[Ie.VERBOSE=1]="VERBOSE",Ie[Ie.INFO=2]="INFO",Ie[Ie.WARN=3]="WARN",Ie[Ie.ERROR=4]="ERROR",Ie[Ie.SILENT=5]="SILENT";const Te={debug:Ee.DEBUG,verbose:Ee.VERBOSE,info:Ee.INFO,warn:Ee.WARN,error:Ee.ERROR,silent:Ee.SILENT},Ce=Ee.INFO,Se={[Ee.DEBUG]:"log",[Ee.VERBOSE]:"log",[Ee.INFO]:"info",[Ee.WARN]:"warn",[Ee.ERROR]:"error"},ke=(e,t,...n)=>{if(t<e.logLevel)return;const i=(new Date).toISOString(),r=Se[t];if(!r)throw new Error(`Attempted to log a message with an invalid logType (value: ${t})`);console[r](`[${i}]  ${e.name}:`,...n)};class Re{constructor(e){this.name=e,this._logLevel=Ce,this._logHandler=ke,this._userLogHandler=null,be.push(this)}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in Ee))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel="string"==typeof e?Te[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if("function"!=typeof e)throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,Ee.DEBUG,...e),this._logHandler(this,Ee.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,Ee.VERBOSE,...e),this._logHandler(this,Ee.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,Ee.INFO,...e),this._logHandler(this,Ee.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,Ee.WARN,...e),this._logHandler(this,Ee.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,Ee.ERROR,...e),this._logHandler(this,Ee.ERROR,...e)}}let Ae,Ne;const Oe=new WeakMap,Pe=new WeakMap,Le=new WeakMap,De=new WeakMap,xe=new WeakMap;let Me={get(e,t,n){if(e instanceof IDBTransaction){if("done"===t)return Pe.get(e);if("objectStoreNames"===t)return e.objectStoreNames||Le.get(e);if("store"===t)return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return Be(e[t])},set:(e,t,n)=>(e[t]=n,!0),has:(e,t)=>e instanceof IDBTransaction&&("done"===t||"store"===t)||t in e};function Ue(e){return e!==IDBDatabase.prototype.transaction||"objectStoreNames"in IDBTransaction.prototype?(Ne||(Ne=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])).includes(e)?function(...t){return e.apply(je(this),t),Be(Oe.get(this))}:function(...t){return Be(e.apply(je(this),t))}:function(t,...n){const i=e.call(je(this),t,...n);return Le.set(i,t.sort?t.sort():[t]),Be(i)}}function Fe(e){return"function"==typeof e?Ue(e):(e instanceof IDBTransaction&&function(e){if(Pe.has(e))return;const t=new Promise(((t,n)=>{const i=()=>{e.removeEventListener("complete",r),e.removeEventListener("error",s),e.removeEventListener("abort",s)},r=()=>{t(),i()},s=()=>{n(e.error||new DOMException("AbortError","AbortError")),i()};e.addEventListener("complete",r),e.addEventListener("error",s),e.addEventListener("abort",s)}));Pe.set(e,t)}(e),t=e,(Ae||(Ae=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])).some((e=>t instanceof e))?new Proxy(e,Me):e);var t}function Be(e){if(e instanceof IDBRequest)return function(e){const t=new Promise(((t,n)=>{const i=()=>{e.removeEventListener("success",r),e.removeEventListener("error",s)},r=()=>{t(Be(e.result)),i()},s=()=>{n(e.error),i()};e.addEventListener("success",r),e.addEventListener("error",s)}));return t.then((t=>{t instanceof IDBCursor&&Oe.set(t,e)})).catch((()=>{})),xe.set(t,e),t}(e);if(De.has(e))return De.get(e);const t=Fe(e);return t!==e&&(De.set(e,t),xe.set(t,e)),t}const je=e=>xe.get(e);function qe(e,t,{blocked:n,upgrade:i,blocking:r,terminated:s}={}){const o=indexedDB.open(e,t),a=Be(o);return i&&o.addEventListener("upgradeneeded",(e=>{i(Be(o.result),e.oldVersion,e.newVersion,Be(o.transaction),e)})),n&&o.addEventListener("blocked",(e=>n(e.oldVersion,e.newVersion,e))),a.then((e=>{s&&e.addEventListener("close",(()=>s())),r&&e.addEventListener("versionchange",(e=>r(e.oldVersion,e.newVersion,e)))})).catch((()=>{})),a}const Ve=["get","getKey","getAll","getAllKeys","count"],He=["put","add","delete","clear"],$e=new Map;function ze(e,t){if(!(e instanceof IDBDatabase)||t in e||"string"!=typeof t)return;if($e.get(t))return $e.get(t);const n=t.replace(/FromIndex$/,""),i=t!==n,r=He.includes(n);if(!(n in(i?IDBIndex:IDBObjectStore).prototype)||!r&&!Ve.includes(n))return;const s=async function(e,...t){const s=this.transaction(e,r?"readwrite":"readonly");let o=s.store;return i&&(o=o.index(t.shift())),(await Promise.all([o[n](...t),r&&s.done]))[0]};return $e.set(t,s),s}Me=(e=>({...e,get:(t,n,i)=>ze(t,n)||e.get(t,n,i),has:(t,n)=>!!ze(t,n)||e.has(t,n)}))(Me);
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e);return jt.test(t)?t:""}catch(e){return""}}function Vt(e){return`${e.appName}!${e.appId}`}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Di{constructor(e){this.allowedEvents_=e,this.listeners_={},v(Array.isArray(e)&&e.length>0,"Requires a non-empty array")}trigger(e,...t){if(Array.isArray(this.listeners_[e])){const n=[...this.listeners_[e]];for(let e=0;e<n.length;e++)n[e].callback.apply(n[e].context,t)}}on(e,t,n){this.validateEventType_(e),this.listeners_[e]=this.listeners_[e]||[],this.listeners_[e].push({callback:t,context:n});const i=this.getInitialEvent(e);i&&t.apply(n,i)}off(e,t,n){this.validateEventType_(e);const i=this.listeners_[e]||[];for(let e=0;e<i.length;e++)if(i[e].callback===t&&(!n||n===i[e].context))return void i.splice(e,1)}validateEventType_(e){v(this.allowedEvents_.find((t=>t===e)),"Unknown event: "+e)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nr(e){return{type:"value",snapshotNode:e}}function Or(e,t){return{type:"child_added",snapshotNode:t,childName:e}}function Pr(e,t){return{type:"child_removed",snapshotNode:t,childName:e}}function Lr(e,t,n){return{type:"child_changed",snapshotNode:t,childName:e,oldSnap:n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ur extends Li{constructor(e,t,n,i){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=n,this.appCheckTokenProvider_=i,this.log_=ei("p:rest:"),this.listens_={}}reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return void 0!==t?"tag$"+t:(v(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,t,n,i){const r=e._path.toString();this.log_("Listen called for "+r+" "+e._queryIdentifier);const s=Ur.getListenId_(e,n),o={};this.listens_[s]=o;const a=xr(e._queryParams);this.restRequest_(r+".json",a,((e,t)=>{let a=t;if(404===e&&(a=null,e=null),null===e&&this.onDataUpdate_(r,a,!1,n),te(this.listens_,s)===o){let t;t=e?401===e?"permission_denied":"rest_error:"+e:"ok",i(t,null)}}))}unlisten(e,t){const n=Ur.getListenId_(e,t);delete this.listens_[n]}get(e){const t=xr(e._queryParams),n=e._path.toString(),i=new x;return this.restRequest_(n+".json",t,((e,t)=>{let r=t;404===e&&(r=null,e=null),null===e?(this.onDataUpdate_(n,r,!1,null),i.resolve(r)):i.reject(new Error(r))})),i.promise}refreshAuthToken(e){}restRequest_(e,t={},n){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then((([i,r])=>{i&&i.accessToken&&(t.auth=i.accessToken),r&&r.token&&(t.ac=r.token);const s=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+oe(t);this.log_("Sending REST request for "+s);const o=new XMLHttpRequest;o.onreadystatechange=()=>{if(n&&4===o.readyState){this.log_("REST Response for "+s+" received. status:",o.status,"response:",o.responseText);let e=null;if(o.status>=200&&o.status<300){try{e=Y(o.responseText)}catch(e){ii("Failed to parse JSON response for "+s+": "+o.responseText)}n(null,e)}else 401!==o.status&&404!==o.status&&ii("Got unsuccessful REST response for "+s+" Status: "+o.status),n(o.status);n=null}},o.open("GET",s,!0),o.send()}))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Br(){return{value:null,children:new Map}}function jr(e,t,n){if(zi(t))e.value=n,e.children.clear();else if(null!==e.value)e.value=e.value.updateChild(t,n);else{const i=Fi(t);e.children.has(i)||e.children.set(i,Br());jr(e.children.get(i),t=ji(t),n)}}function qr(e,t,n){null!==e.value?n(t,e.value):function(e,t){e.children.forEach(((e,n)=>{t(n,e)}))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Gr{constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=$r.OVERWRITE}operationForChild(e){return zi(this.path)?new Gr(this.source,Ui(),this.snap.getImmediateChild(e)):new Gr(this.source,ji(this.path),this.snap)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yr{constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=$r.MERGE}operationForChild(e){if(zi(this.path)){const t=this.children.subtree(new Mi(e));return t.isEmpty()?null:t.value?new Gr(this.source,Ui(),t.value):new Yr(this.source,Ui(),t)}return v(Fi(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Yr(this.source,ji(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let is;class rs{constructor(e,t=(()=>(is||(is=new ar(oi)),is))()){this.value=e,this.children=t}static fromObject(e){let t=new rs(null);return hi(e,((e,n)=>{t=t.set(new Mi(e),n)})),t}isEmpty(){return null===this.value&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(null!=this.value&&t(this.value))return{path:Ui(),value:this.value};if(zi(e))return null;{const n=Fi(e),i=this.children.get(n);if(null!==i){const r=i.findRootMostMatchingPathAndValue(ji(e),t);if(null!=r){return{path:$i(new Mi(n),r.path),value:r.value}}return null}return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,(()=>!0))}subtree(e){if(zi(e))return this;{const t=Fi(e),n=this.children.get(t);return null!==n?n.subtree(ji(e)):new rs(null)}}set(e,t){if(zi(e))return new rs(t,this.children);{const n=Fi(e),i=(this.children.get(n)||new rs(null)).set(ji(e),t),r=this.children.insert(n,i);return new rs(this.value,r)}}remove(e){if(zi(e))return this.children.isEmpty()?new rs(null):new rs(null,this.children);{const t=Fi(e),n=this.children.get(t);if(n){const i=n.remove(ji(e));let r;return r=i.isEmpty()?this.children.remove(t):this.children.insert(t,i),null===this.value&&r.isEmpty()?new rs(null):new rs(this.value,r)}return this}}get(e){if(zi(e))return this.value;{const t=Fi(e),n=this.children.get(t);return n?n.get(ji(e)):null}}setTree(e,t){if(zi(e))return t;{const n=Fi(e),i=(this.children.get(n)||new rs(null)).setTree(ji(e),t);let r;return r=i.isEmpty()?this.children.remove(n):this.children.insert(n,i),new rs(this.value,r)}}fold(e){return this.fold_(Ui(),e)}fold_(e,t){const n={};return this.children.inorderTraversal(((i,r)=>{n[i]=r.fold_($i(e,i),t)})),t(e,this.value,n)}findOnPath(e,t){return this.findOnPath_(e,Ui(),t)}findOnPath_(e,t,n){const i=!!this.value&&n(t,this.value);if(i)return i;if(zi(e))return null;{const i=Fi(e),r=this.children.get(i);return r?r.findOnPath_(ji(e),$i(t,i),n):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,Ui(),t)}foreachOnPath_(e,t,n){if(zi(e))return this;{this.value&&n(t,this.value);const i=Fi(e),r=this.children.get(i);return r?r.foreachOnPath_(ji(e),$i(t,i),n):new rs(null)}}foreach(e){this.foreach_(Ui(),e)}foreach_(e,t){this.children.inorderTraversal(((n,i)=>{i.foreach_($i(e,n),t)})),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal(((t,n)=>{n.value&&e(t,n.value)}))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ns{constructor(){this.changeMap=new Map}trackChildChange(e){const t=e.type,n=e.childName;v("child_added"===t||"child_changed"===t||"child_removed"===t,"Only child changes supported for tracking"),v(".priority"!==n,"Only non-priority child changes can be tracked.");const i=this.changeMap.get(n);if(i){const r=i.type;if("child_added"===t&&"child_removed"===r)this.changeMap.set(n,Lr(n,e.snapshotNode,i.snapshotNode));else if("child_removed"===t&&"child_added"===r)this.changeMap.delete(n);else if("child_removed"===t&&"child_changed"===r)this.changeMap.set(n,Pr(n,i.oldSnap));else if("child_changed"===t&&"child_added"===r)this.changeMap.set(n,Or(n,e.snapshotNode));else{if("child_changed"!==t||"child_changed"!==r)throw w("Illegal combination of changes: "+e+" occurred after "+i);this.changeMap.set(n,Lr(n,e.snapshotNode,i.oldSnap))}}else this.changeMap.set(n,e)}getChanges(){return Array.from(this.changeMap.values())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ls(e,t,n,i,r){const s=new Ns;let o,a;if(n.type===$r.OVERWRITE){const c=n;c.source.fromUser?o=Ms(e,t,c.path,c.snap,i,r,s):(v(c.source.fromServer,"Unknown source."),a=c.source.tagged||t.serverCache.isFiltered()&&!zi(c.path),o=xs(e,t,c.path,c.snap,i,r,a,s))}else if(n.type===$r.MERGE){const c=n;c.source.fromUser?o=function(e,t,n,i,r,s,o){let a=t;return i.foreach(((i,c)=>{const l=$i(n,i);Us(t,Fi(l))&&(a=Ms(e,a,l,c,r,s,o))})),i.foreach(((i,c)=>{const l=$i(n,i);Us(t,Fi(l))||(a=Ms(e,a,l,c,r,s,o))})),a}(e,t,c.path,c.children,i,r,s):(v(c.source.fromServer,"Unknown source."),a=c.source.tagged||t.serverCache.isFiltered(),o=Bs(e,t,c.path,c.children,i,r,a,s))}else if(n.type===$r.ACK_USER_WRITE){const a=n;o=a.revert?function(e,t,n,i,r,s){let o;if(null!=Cs(i,n))return t;{const a=new Ps(i,t,r),c=t.eventCache.getNode();let l;if(zi(n)||".priority"===Fi(n)){let n;if(t.serverCache.isFullyInitialized())n=Es(i,ns(t));else{const e=t.serverCache.getNode();v(e instanceof Cr,"serverChildren would be complete if leaf node"),n=Is(i,e)}l=e.filter.updateFullNode(c,n,s)}else{const r=Fi(n);let h=ks(i,r,t.serverCache);null==h&&t.serverCache.isCompleteForChild(r)&&(h=c.getImmediateChild(r)),l=null!=h?e.filter.updateChild(c,r,h,ji(n),a,s):t.eventCache.getNode().hasChild(r)?e.filter.updateChild(c,r,Cr.EMPTY_NODE,ji(n),a,s):c,l.isEmpty()&&t.serverCache.isFullyInitialized()&&(o=Es(i,ns(t)),o.isLeafNode()&&(l=e.filter.updateFullNode(l,o,s)))}return o=t.serverCache.isFullyInitialized()||null!=Cs(i,Ui()),Zr(t,l,o,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ao{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function No(e,t){let n=null;for(let i=0;i<t.length;i++){const r=t[i],s=r.getPath();null===n||Ki(s,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:s}),n.events.push(r)}n&&e.eventLists_.push(n)}function Oo(e,t,n){No(e,n),Po(e,(e=>Gi(e,t)||Gi(t,e)))}function Po(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const r=e.eventLists_[i];if(r){t(r.path)?(Lo(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function Lo(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();Jn&&Zn("event: "+n.toString()),pi(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){jn("10.6.0"),Qe(new ye("database",((e,{instanceIdentifier:t})=>sa(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),rt("@firebase/database","1.0.1",e),rt("@firebase/database","1.0.1","esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class ju{constructor(e){this.path=e}static fromPath(e){return new ju(Bu.fromString(e))}static fromName(e){return new ju(Bu.fromString(e).popFirst(5))}static empty(){return new ju(Bu.emptyPath())}get collectionGroup(){return this.path.popLast().lastSegment()}hasCollectionId(e){return this.path.length>=2&&this.path.get(this.path.length-2)===e}getCollectionGroup(){return this.path.get(this.path.length-2)}getCollectionPath(){return this.path.popLast()}isEqual(e){return null!==e&&0===Bu.comparator(this.path,e.path)}toString(){return this.path.toString()}static comparator(e,t){return Bu.comparator(e.path,t.path)}static isDocumentKey(e){return e.length%2==0}static fromSegments(e){return new ju(new Bu(e.slice()))}}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
new Gu(ju.comparator);new Gu(ju.comparator);new Gu(ju.comparator),new Xu(ju.comparator);new Xu(Uu);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nd(e,...t){throw Ld(e,...t)}function Od(e,...t){return Ld(e,...t)}function Pd(e,t,n){const i=Object.assign(Object.assign({},Sd()),{[t]:n});return new K("auth","Firebase",i).create(t,{appName:e.name})}function Ld(e,...t){if("string"!=typeof e){const n=t[0],i=[...t.slice(1)];return i[0]&&(i[0].appName=e.name),e._errorFactory.create(n,...i)}return kd.create(e,...t)}function Dd(e,t,...n){if(!e)throw Ld(t,...n)}function xd(e){const t="INTERNAL ASSERTION FAILED: "+e;throw Ad(t),new Error(t)}function Md(e,t){e||xd(t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ud(){var e;return"undefined"!=typeof self&&(null===(e=self.location)||void 0===e?void 0:e.href)||""}function Fd(){return"http:"===Bd()||"https:"===Bd()}function Bd(){var e;return"undefined"!=typeof self&&(null===(e=self.location)||void 0===e?void 0:e.protocol)||null}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class jd{constructor(e,t){this.shortDelay=e,this.longDelay=t,Md(t>e,"Short delay should be less than long delay!"),this.isMobile=F()||j()}get(){return"undefined"!=typeof navigator&&navigator&&"onLine"in navigator&&"boolean"==typeof navigator.onLine&&(Fd()||B()||"connection"in navigator)&&!navigator.onLine?Math.min(5e3,this.shortDelay):this.isMobile?this.longDelay:this.shortDelay}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class hf{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){Dd(e.idToken,"internal-error"),Dd(void 0!==e.idToken,"internal-error"),Dd(void 0!==e.refreshToken,"internal-error");const t="expiresIn"in e&&void 0!==e.expiresIn?Number(e.expiresIn):function(e){const t=sf(e);return Dd(t,"internal-error"),Dd(void 0!==t.exp,"internal-error"),Dd(void 0!==t.iat,"internal-error"),Number(t.exp)-Number(t.iat)}(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}async getToken(e,t=!1){return Dd(!this.accessToken||this.refreshToken,e,"user-token-expired"),t||!this.accessToken||this.isExpired?this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null:this.accessToken}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:n,refreshToken:i,expiresIn:r}=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Zf{constructor(){this.providerId=Zf.PROVIDER_ID}static credential(e,t){return Kf._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const n=Qf.parseLink(t);return Dd(n,"argument-error"),Kf._fromEmailAndCode(e,n.code,n.tenantId)}}Zf.PROVIDER_ID="password",Zf.EMAIL_PASSWORD_SIGN_IN_METHOD="password",Zf.EMAIL_LINK_SIGN_IN_METHOD="emailLink";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function fp(e,t,n=!1){const i="signIn",r=await hp(e,i,t),s=await ap._fromIdTokenResponse(e,i,r);return n||await e._updateCurrentUser(s.user),s}async function pp(e,t){return fp(Df(e),t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
Uf("rcb"),new jd(3e4,6e4);async function xp(e,t,n){var i;const r=await n.verify();try{let s;if(Dd("string"==typeof r,e,"argument-error"),Dd("recaptcha"===n.type,e,"argument-error"),s="string"==typeof t?{phoneNumber:t}:t,"session"in s){const t=s.session;if("phoneNumber"in s){Dd("enroll"===t.type,e,"internal-error");const n=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Up(e,t){return t?pf(t):(Dd(e._popupRedirectResolver,e,"argument-error"),e._popupRedirectResolver)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cg=new jd(5e3,15e3),lg={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},hg=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function ug(e){const t=e.config;Dd(t.authDomain,e,"auth-domain-config-required");const n=t.emulator?qd(t,"emulator/auth/iframe"):`https://${e.config.authDomain}/__/auth/iframe`,i={apiKey:t.apiKey,appName:e.name,v:"10.6.0"},r=hg.get(e.config.apiHost);r&&(i.eid=r);const s=e._getFrameworks();return s.length&&(i.fw=s.join(",")),`${n}?${oe(i).slice(1)}`}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(t||"",a),new fg(null);const u=window.open(t||"",a,h);Dd(u,e,"popup-blocked");try{u.focus()}catch(e){}return new fg(u)}const gg=encodeURIComponent("fac");async function mg(e,t,n,i,r,s){Dd(e.config.authDomain,e,"auth-domain-config-required"),Dd(e.config.apiKey,e,"invalid-api-key");const o={apiKey:e.config.apiKey,appName:e.name,authType:n,redirectUrl:i,v:"10.6.0",eventId:r};if(t instanceof ep){t.setDefaultLanguage(e.languageCode),o.providerId=t.providerId||"",ne(t.getCustomParameters())||(o.customParameters=JSON.stringify(t.getCustomParameters()));for(const[e,t]of Object.entries(s||{}))o[e]=t}if(t instanceof tp){const e=t.getScopes().filter((e=>""!==e));e.length>0&&(o.scopes=e.join(","))}e.tenantId&&(o.tid=e.tenantId);const a=o;for(const e of Object.keys(a))void 0===a[e]&&delete a[e];const c=await e._getAppCheckToken(),l=c?`#${gg}=${encodeURIComponent(c)}`:"";return`${function({config:e}){return e.emulator?qd(e,"emulator/auth/handler"):`https://${e.authDomain}/__/auth/handler`}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e)}?${oe(a).slice(1)}${l}`}const _g=class{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Ep,this._completeRedirectFn=Jp,this._overrideRedirectResult=Kp}async _openPopup(e,t,n,i){var r;Md(null===(r=this.eventManagers[e._key()])||void 0===r?void 0:r.manager,"_initialize() not called before _openPopup()");return pg(e,await mg(e,t,n,Ud(),i),Tp())}async _openRedirect(e,t,n,i){await this._originValidation(e);return function(e){Sp().location.href=e}(await mg(e,t,n,Ud(),i)),new Promise((()=>{}))}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:e,promise:n}=this.eventManagers[t];return e?Promise.resolve(e):(Md(n,"If manager is not set, promise should be"),n)}const n=this.initAndGetManager(e);return this.eventManagers[t]={promise:n},n.catch((()=>{delete this.eventManagers[t]})),n}async initAndGetManager(e){const t=await async function(e){const t=await ag(e),n=Sp().gapi;return Dd(n,e,"internal-error"),t.open({where:document.body,url:ug(e),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:lg,dontclear:!0},(t=>new Promise((async(n,i)=>{await t.restyle({setHideOnLeave:!1});const r=Od(e,"network-request-failed"),s=Sp().setTimeout((()=>{i(r)}),cg.get());function o(){Sp().clearTimeout(s),n(t)}t.ping(o).then(o,(()=>{i(r)}))}))))}(e),n=new Xp(e);return t.register("authEvent",(t=>{Dd(null==t?void 0:t.authEvent,e,"invalid-auth-event");return{status:n.onEvent(t.authEvent)?"ACK":"ERROR"}}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:n},this.iframes[e._key()]=t,n}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send("webStorageSupport",{type:"webStorageSupport"},(n=>{var i;const r=null===(i=null==n?void 0:n[0])||void 0===i?void 0:i.webStorageSupport;void 0!==r&&t(!!r),Nd(e,"internal-error")}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=ng(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Af()||bf()||kf()}};
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const vg=D("authIdTokenMaxAge")||300;let wg=null;var bg;bg="Browser",Qe(new ye("auth",((e,{options:t})=>{const n=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),r=e.getProvider("app-check-internal"),{apiKey:s,authDomain:o}=n.options;Dd(s&&!s.includes(":"),"invalid-api-key",{appName:n.name});const a={apiKey:s,authDomain:o,clientPlatform:bg,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Nf(bg)},c=new Lf(n,i,r,a);return function(e,t){const n=(null==t?void 0:t.persistence)||[],i=(Array.isArray(n)?n:[n]).map(pf);(null==t?void 0:t.errorMap)&&e._updateErrorMap(t.errorMap),e._initializeWithPersistence(i,null==t?void 0:t.popupRedirectResolver)}(c,t),c}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(((e,t,n)=>{e.getProvider("auth-internal").initialize()}))),Qe(new ye("auth-internal",(e=>{const t=Df(e.getProvider("auth").getImmediate());return new yg(t)}),"PRIVATE").setInstantiationMode("EXPLICIT")),rt("@firebase/auth","1.4.0",function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(bg)),rt("@firebase/auth","1.4.0","esm2017");
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Lg{constructor(e,t){this.bucket=e,this.path_=t}get path(){return this.path_}get isRoot(){return 0===this.path.length}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,t){let n;try{n=Lg.makeFromUrl(e,t)}catch(t){return new Lg(e,"")}if(""===n.path)return n;throw i=e,new Eg(Ig.INVALID_DEFAULT_BUCKET,"Invalid default bucket '"+i+"'.");var i}static makeFromUrl(e,t){let n=null;const i="([A-Za-z0-9.\\-_]+)";const r=new RegExp("^gs://"+i+"(/(.*))?$","i");function s(e){e.path_=decodeURIComponent(e.path)}const o=t.replace(/[.]/g,"\\."),a=[{regex:r,indices:{bucket:1,path:3},postModify:function(e){"/"===e.path.charAt(e.path.length-1)&&(e.path_=e.path_.slice(0,-1))}},{regex:new RegExp(`^https?://${o}/v[A-Za-z0-9_]+/b/${i}/o(/([^?#]*).*)?$`,"i"),indices:{bucket:1,path:3},postModify:s},{regex:new RegExp(`^https?://${"firebasestorage.googleapis.com"===t?"(?:storage.googleapis.com|storage.cloud.google.com)":t}/${i}/([^?#]*)`,"i"),indices:{bucket:1,path:2},postModify:s}];for(let t=0;t<a.length;t++){const i=a[t],r=i.regex.exec(e);if(r){const e=r[i.indices.bucket];let t=r[i.indices.path];t||(t=""),n=new Lg(e,t),i.postModify(n);break}}if(null==n)throw function(e){return new Eg(Ig.INVALID_URL,"Invalid URL '"+e+"'.")}(e);return n}}class Dg{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class qg{constructor(e,t){this._service=e,this._location=t instanceof Lg?t:Lg.makeFromUrl(t,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,t){return new qg(e,t)}get root(){const e=new Lg(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return jg(this._location.path)}get storage(){return this._service}get parent(){const e=
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(n,...i)}(zg),function(e=it()){const t=Ze(e=_e(e),"analytics");t.isInitialized()?t.getImmediate():function(e,t={}){const n=Ze(e,"analytics");if(n.isInitialized()){const e=n.getImmediate();if(re(t,n.getOptions()))return e;throw fn.create("already-initialized")}n.initialize({options:t})}(e)}(zg),{form:document.querySelector(".form"),input:document.getElementById("search-input"),button:document.querySelector(".search-button"),gallery:document.querySelector(".gallery"),buttonLoadMore:document.querySelector(".load-more"),modal:document.querySelector(".modal"),modalContent:document.querySelector(".modal_data"),movieImage:document.querySelector(".movie_image"),movieDescr:document.querySelector(".movie_descr"),buttonClose:document.querySelectorAll(".modal_close"),modalBackdrop:document.querySelectorAll(".modal_body"),body:document.querySelector("body"),content:document.getElementById("content"),headerNavLinks:document.querySelectorAll(".nav_item"),headerNavButtons:document.querySelector(".nav_list_button"),buttonWatched:document.getElementById("watched"),buttonQueue:document.getElementById("queue"),butttonsLibrary:document.querySelector(".modal_nav"),buttonHeaderNav:document.querySelector(".nav_list_button"),logo:document.querySelector(".logo"),homeBtn:document.getElementById("home_btn"),libraryBtn:document.getElementById("library_btn"),signOut:document.getElementById("auth_btn"),modalLogin:document.getElementById("login"),modalRegister:document.getElementById("register"),formsAuth:document.querySelectorAll(".form_auth"),registerLink:document.getElementById("register_link"),loginLink:document.getElementById("login_link"),loginButton:document.getElementById("login_btn"),registerButton:document.getElementById("register_btn"),txtEmail:document.getElementById("txtEmail"),txtPassword:document.getElementById("txtPassword"),regEmail:document.getElementById("regEmail"),regPassword:document.getElementById("regPassword"),regPassword_:document.getElementById("regPassword_")});function Gg(e,t){try{const n=JSON.stringify(t);localStorage.setItem(e,n)}catch(e){console.log(e.message)}}function Yg(e){try{const t=localStorage.getItem(e);if(t)return JSON.parse(t)}catch(e){console.log(e.message)}}function Jg(e){const t=Yg("genres")||[];if(t){return t.filter((t=>e.includes(t.id))).map((e=>e.name))}}function Xg(e){const t=e.map((({poster_path:e,original_title:t,id:n,genre_ids:i,genres:r,release_date:s,vote_average:o})=>function({poster_path:e,original_title:t,id:n,genre_ids:i,genres:r,release_date:s,vote_average:o}){const a=new Date(s).getFullYear(),c=e?`<li class="gallery_card">\n         <a\n           class="gallery_link"\n          href="https://image.tmdb.org/t/p/w500${e}"\n         >\n           <img\n           id="${n}"\n             class="movie_img"\n             src="https://image.tmdb.org/t/p/w500${e}"\n             alt="${t}"\n           \n             loading="lazy"\n           />\n             <p class="movie_title card">${t}</p>\n         <div class="movie_describtion">\n          <ul class="movie_genresList">${nm(r,i)}</ul>\n           <p>${a}</p>\n           <p class="movie_average">${o.toFixed(1)}</p>\n         </div>\n         </a>      \n  </li>`:`<li class="gallery_card">\n         <a\n           class="gallery__link"\n          href="https://raw.githubusercontent.com/MarynaDanyliuk/goit-react-hw-05-movies/main/src/img/default_image_large.jpg"\n         >\n           <img\n           id="${n}"\n            class="movie_img"\n             src="https://raw.githubusercontent.com/MarynaDanyliuk/goit-react-hw-05-movies/main/src/img/default_image_large.jpg"\n             alt="${t}"\n             loading="lazy"\n           />\n          <p class="movie_title card">${t}</p>\n         <div class="movie_describtion">\n           <ul>${nm(r,i)}</ul>\n           <p>${a}</p>\n           <p class="movie_average">${o.toFixed(1)}</p>\n         </div>\n         </a>\n      </li>`;Kg.gallery.insertAdjacentHTML("beforeend",c)}({poster_path:e,original_title:t,id:n,genre_ids:i,genres:r,release_date:s,vote_average:o}))).join("");Kg.gallery.insertAdjacentHTML("beforeend",t)}function Qg({poster_path:e,original_title:t}){const n=e?`<img\n          src="https://image.tmdb.org/t/p/w500${e}"\n          alt=${t}\n          class="image"\n          \n        />`:'<img\n          src="https://raw.githubusercontent.com/MarynaDanyliuk/goit-react-hw-05-movies/main/src/img/default_image_large.jpg"\n          alt="default image"\n          class="image"\n          style="width: 375px; height: 478px"\n        />';Kg.movieImage.insertAdjacentHTML("beforeend",n)}function Zg({original_title:e,vote_average:t,vote_count:n,popularity:i,genres:r,overview:s}){const o=r.map((({name:e})=>e)).join(", "),a=`\n        <div class="movie_descr">\n          <h1 class="movie_title">${e}</h1>\n          <table class="movie_inform">\n            <tr class="movie_info_item">\n              <td class="list_category">Vote/Votes</td>\n              <td class="list_data"><span class="average">${t.toFixed(1)}</span> / <span class="count">${n}</span></td>\n            </tr>\n            <tr class="movie_info_item">\n              <td class="list_category">Popularity</td>\n              <td class="list_data">${i.toFixed(1)}</td>\n            </tr>\n            <tr class="movie_info_item">\n              <td class="list_category">Original Title</td>\n              <td class="list_data" style="text-transform: uppercase">${e}</td>\n            </tr>\n            <tr class="movie_info_item">\n              <td class="list_category">Genre</td>\n              <td class="list_data genres">${o}</td>\n            </tr>\n          </table>\n          <p class="movie_title about">About</p>\n          <p class="movie_about">\n          ${s}\n          </p>\n        </div>\n\n  `;Kg.movieDescr.insertAdjacentHTML("beforeend",a)}function em(){Kg.gallery.innerHTML=""}function tm(e){if(e)return Kg.input.value="",Kg.homeBtn.classList.add("nav_item--current"),Kg.libraryBtn.classList.remove("nav_item--current"),Kg.headerNavButtons.classList.add("not-visible"),void Kg.form.classList.remove("not-visible");e||(Kg.homeBtn.classList.add("nav_item--current"),Kg.libraryBtn.classList.remove("nav_item--current"),Kg.headerNavButtons.classList.add("not-visible"),Kg.form.classList.remove("not-visible"),Kg.signOut.classList.add("not-visible"))}const nm=(e,t)=>{if(e){const t=e.splice(0,2).map((({name:e})=>e)).join(", ");return e.length>=3?`<li class="movie_gnr">${t}, Other</li>`:`<li class="movie_gnr">${t}</li>`}if(t){const e=Jg(t).splice(0,2).join(", ");return t.length>=3?`<li class="movie_gnr">${e}, Other</li>`:`<li class="movie_gnr">${e}</li>`}};function im(e){const t=Yg(e);if(t)return Xg(t)}function rm(e,t){return function(){return e.apply(t,arguments)}}const{toString:sm}=Object.prototype,{getPrototypeOf:om}=Object,am=(cm=Object.create(null),e=>{const t=sm.call(e);return cm[t]||(cm[t]=t.slice(8,-1).toLowerCase())});var cm;const lm=e=>(e=e.toLowerCase(),t=>am(t)===e),hm=e=>t=>typeof t===e,{isArray:um}=Array,dm=hm("undefined");const fm=lm("ArrayBuffer");const pm=hm("string"),gm=hm("function"),mm=hm("number"),_m=e=>null!==e&&"object"==typeof e,ym=e=>{if("object"!==am(e))return!1;const t=om(e);return!(null!==t&&t!==Object.prototype&&null!==Object.getPrototypeOf(t)||Symbol.toStringTag in e||Symbol.iterator in e)},vm=lm("Date"),wm=lm("File"),bm=lm("Blob"),Em=lm("FileList"),Im=lm("URLSearchParams");function Tm(e,t,{allOwnKeys:n=!1}={}){if(null==e)return;let i,r;if("object"!=typeof e&&(e=[e]),um(e))for(i=0,r=e.length;i<r;i++)t.call(null,e[i],i,e);else{const r=n?Object.getOwnPropertyNames(e):Object.keys(e),s=r.length;let o;for(i=0;i<s;i++)o=r[i],t.call(null,e[o],o,e)}}function Cm(e,t){t=t.toLowerCase();const n=Object.keys(e);let i,r=n.length;for(;r-- >0;)if(i=n[r],t===i.toLowerCase())return i;return null}const Sm="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:i,km=e=>!dm(e)&&e!==Sm;const Rm=(Am="undefined"!=typeof Uint8Array&&om(Uint8Array),e=>Am&&e instanceof Am);var Am;const Nm=lm("HTMLFormElement"),Om=(({hasOwnProperty:e})=>(t,n)=>e.call(t,n))(Object.prototype),Pm=lm("RegExp"),Lm=(e,t)=>{const n=Object.getOwnPropertyDescriptors(e),i={};Tm(n,((n,r)=>{let s;!1!==(s=t(n,r,e))&&(i[r]=s||n)})),Object.defineProperties(e,i)},Dm={DIGIT:"0123456789",ALPHA:"abcdefghijklmnopqrstuvwxyz",ALPHA_DIGIT:"abcdefghijklmnopqrstuvwxyz"+"abcdefghijklmnopqrstuvwxyz".toUpperCase()+"0123456789"};const xm=lm("AsyncFunction");var Mm={isArray:um,isArrayBuffer:fm,isBuffer:function(e){return null!==e&&!dm(e)&&null!==e.constructor&&!dm(e.constructor)&&gm(e.constructor.isBuffer)&&e.constructor.isBuffer(e)},isFormData:e=>{let t;return e&&("function"==typeof FormData&&e instanceof FormData||gm(e.append)&&("formdata"===(t=am(e))||"object"===t&&gm(e.toString)&&"[object FormData]"===e.toString()))},isArrayBufferView:function(e){let t;return t="undefined"!=typeof ArrayBuffer&&ArrayBuffer.isView?ArrayBuffer.isView(e):e&&e.buffer&&fm(e.buffer),t},isString:pm,isNumber:mm,isBoolean:e=>!0===e||!1===e,isObject:_m,isPlainObject:ym,isUndefined:dm,isDate:vm,isFile:wm,isBlob:bm,isRegExp:Pm,isFunction:gm,isStream:e=>_m(e)&&gm(e.pipe),isURLSearchParams:Im,isTypedArray:Rm,isFileList:Em,forEach:Tm,merge:function e(){const{caseless:t}=km(this)&&this||{},n={},i=(i,r)=>{const s=t&&Cm(n,r)||r;ym(n[s])&&ym(i)?n[s]=e(n[s],i):ym(i)?n[s]=e({},i):um(i)?n[s]=i.slice():n[s]=i};for(let e=0,t=arguments.length;e<t;e++)arguments[e]&&Tm(arguments[e],i);return n},extend:(e,t,n,{allOwnKeys:i}={})=>(Tm(t,((t,i)=>{n&&gm(t)?e[i]=rm(t,n):e[i]=t}),{allOwnKeys:i}),e),trim:e=>e.trim?e.trim():e.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,""),stripBOM:e=>(65279===e.charCodeAt(0)&&(e=e.slice(1)),e),inherits:(e,t,n,i)=>{e.prototype=Object.create(t.prototype,i),e.prototype.constructor=e,Object.defineProperty(e,"super",{value:t.prototype}),n&&Object.assign(e.prototype,n)},toFlatObject:(e,t,n,i)=>{let r,s,o;const a={};if(t=t||{},null==e)return t;do{for(r=Object.getOwnPropertyNames(e),s=r.length;s-- >0;)o=r[s],i&&!i(o,e,t)||a[o]||(t[o]=e[o],a[o]=!0);e=!1!==n&&om(e)}while(e&&(!n||n(e,t))&&e!==Object.prototype);return t},kindOf:am,kindOfTest:lm,endsWith:(e,t,n)=>{e=String(e),(void 0===n||n>e.length)&&(n=e.length),n-=t.length;const i=e.indexOf(t,n);return-1!==i&&i===n},toArray:e=>{if(!e)return null;if(um(e))return e;let t=e.length;if(!mm(t))return null;const n=new Array(t);for(;t-- >0;)n[t]=e[t];return n},forEachEntry:(e,t)=>{const n=(e&&e[Symbol.iterator]).call(e);let i;for(;(i=n.next())&&!i.done;){const n=i.value;t.call(e,n[0],n[1])}},matchAll:(e,t)=>{let n;const i=[];for(;null!==(n=e.exec(t));)i.push(n);return i},isHTMLForm:Nm,hasOwnProperty:Om,hasOwnProp:Om,reduceDescriptors:Lm,freezeMethods:e=>{Lm(e,((t,n)=>{if(gm(e)&&-1!==["arguments","caller","callee"].indexOf(n))return!1;const i=e[n];gm(i)&&(t.enumerable=!1,"writable"in t?t.writable=!1:t.set||(t.set=()=>{throw Error("Can not rewrite read-only method '"+n+"'")}))}))},toObjectSet:(e,t)=>{const n={},i=e=>{e.forEach((e=>{n[e]=!0}))};return um(e)?i(e):i(String(e).split(t)),n},toCamelCase:e=>e.toLowerCase().replace(/[-_\s]([a-z\d])(\w*)/g,(function(e,t,n){return t.toUpperCase()+n})),noop:()=>{},toFiniteNumber:(e,t)=>(e=+e,Number.isFinite(e)?e:t),findKey:Cm,global:Sm,isContextDefined:km,ALPHABET:Dm,generateString:(e=16,t=Dm.ALPHA_DIGIT)=>{let n="";const{length:i}=t;for(;e--;)n+=t[Math.random()*i|0];return n},isSpecCompliantForm:function(e){return!!(e&&gm(e.append)&&"FormData"===e[Symbol.toStringTag]&&e[Symbol.iterator])},toJSONObject:e=>{const t=new Array(10),n=(e,i)=>{if(_m(e)){if(t.indexOf(e)>=0)return;if(!("toJSON"in e)){t[i]=e;const r=um(e)?[]:{};return Tm(e,((e,t)=>{const s=n(e,i+1);!dm(s)&&(r[t]=s)})),t[i]=void 0,r}}return e};return n(e,0)},isAsyncFn:xm,isThenable:e=>e&&(_m(e)||gm(e))&&gm(e.then)&&gm(e.catch)};function Um(e,t,n,i,r){Error.call(this),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=(new Error).stack,this.message=e,this.name="AxiosError",t&&(this.code=t),n&&(this.config=n),i&&(this.request=i),r&&(this.response=r)}Mm.inherits(Um,Error,{toJSON:function(){return{message:this.message,name:this.name,description:this.description,number:this.number,fileName:this.fileName,lineNumber:this.lineNumber,columnNumber:this.columnNumber,stack:this.stack,config:Mm.toJSONObject(this.config),code:this.code,status:this.response&&this.response.status?this.response.status:null}}});const Fm=Um.prototype,Bm={};["ERR_BAD_OPTION_VALUE","ERR_BAD_OPTION","ECONNABORTED","ETIMEDOUT","ERR_NETWORK","ERR_FR_TOO_MANY_REDIRECTS","ERR_DEPRECATED","ERR_BAD_RESPONSE","ERR_BAD_REQUEST","ERR_CANCELED","ERR_NOT_SUPPORT","ERR_INVALID_URL"].forEach((e=>{Bm[e]={value:e}})),Object.defineProperties(Um,Bm),Object.defineProperty(Fm,"isAxiosError",{value:!0}),Um.from=(e,t,n,i,r,s)=>{const o=Object.create(Fm);return Mm.toFlatObject(e,o,(function(e){return e!==Error.prototype}),(e=>"isAxiosError"!==e)),Um.call(o,e.message,t,n,i,r),o.cause=e,o.name=e.name,s&&Object.assign(o,s),o};var jm,qm,Vm,Hm=Um;qm=function(e){var t,n,i=Qm(e),r=i[0],s=i[1],o=new Gm(function(e,t,n){return 3*(t+n)/4-n}(0,r,s)),a=0,c=s>0?r-4:r;for(n=0;n<c;n+=4)t=Km[e.charCodeAt(n)]<<18|Km[e.charCodeAt(n+1)]<<12|Km[e.charCodeAt(n+2)]<<6|Km[e.charCodeAt(n+3)],o[a++]=t>>16&255,o[a++]=t>>8&255,o[a++]=255&t;2===s&&(t=Km[e.charCodeAt(n)]<<2|Km[e.charCodeAt(n+1)]>>4,o[a++]=255&t);1===s&&(t=Km[e.charCodeAt(n)]<<10|Km[e.charCodeAt(n+1)]<<4|Km[e.charCodeAt(n+2)]>>2,o[a++]=t>>8&255,o[a++]=255&t);return o},Vm=function(e){for(var t,n=e.length,i=n%3,r=[],s=16383,o=0,a=n-i;o<a;o+=s)r.push(Zm(e,o,o+s>a?a:o+s));1===i?(t=e[n-1],r.push(Wm[t>>2]+Wm[t<<4&63]+"==")):2===i&&(t=(e[n-2]<<8)+e[n-1],r.push(Wm[t>>10]+Wm[t>>4&63]+Wm[t<<2&63]+"="));return r.join("")}
/*! ieee754. BSD-3-Clause License. Feross Aboukhadijeh <https://feross.org/opensource> */;for(var $m,zm,Wm=[],Km=[],Gm="undefined"!=typeof Uint8Array?Uint8Array:Array,Ym="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",Jm=0,Xm=Ym.length;Jm<Xm;++Jm)Wm[Jm]=Ym[Jm],Km[Ym.charCodeAt(Jm)]=Jm;function Qm(e){var t=e.length;if(t%4>0)throw new Error("Invalid string. Length must be a multiple of 4");var n=e.indexOf("=");return-1===n&&(n=t),[n,n===t?0:4-n%4]}function Zm(e,t,n){for(var i,r,s=[],o=t;o<n;o+=3)i=(e[o]<<16&16711680)+(e[o+1]<<8&65280)+(255&e[o+2]),s.push(Wm[(r=i)>>18&63]+Wm[r>>12&63]+Wm[r>>6&63]+Wm[63&r]);return s.join("")}Km["-".charCodeAt(0)]=62,Km["_".charCodeAt(0)]=63,$m=function(e,t,n,i,r){var s,o,a=8*r-i-1,c=(1<<a)-1,l=c>>1,h=-7,u=n?r-1:0,d=n?-1:1,f=e[t+u];for(u+=d,s=f&(1<<-h)-1,f>>=-h,h+=a;h>0;s=256*s+e[t+u],u+=d,h-=8);for(o=s&(1<<-h)-1,s>>=-h,h+=i;h>0;o=256*o+e[t+u],u+=d,h-=8);if(0===s)s=1-l;else{if(s===c)return o?NaN:1/0*(f?-1:1);o+=Math.pow(2,i),s-=l}return(f?-1:1)*o*Math.pow(2,s-i)},zm=function(e,t,n,i,r,s){var o,a,c,l=8*s-r-1,h=(1<<l)-1,u=h>>1,d=23===r?Math.pow(2,-24)-Math.pow(2,-77):0,f=i?0:s-1,p=i?1:-1,g=t<0||0===t&&1/t<0?1:0;for(t=Math.abs(t),isNaN(t)||t===1/0?(a=isNaN(t)?1:0,o=h):(o=Math.floor(Math.log(t)/Math.LN2),t*(c=Math.pow(2,-o))<1&&(o--,c*=2),(t+=o+u>=1?d/c:d*Math.pow(2,1-u))*c>=2&&(o++,c/=2),o+u>=h?(a=0,o=h):o+u>=1?(a=(t*c-1)*Math.pow(2,r),o+=u):(a=t*Math.pow(2,u-1)*Math.pow(2,r),o=0));r>=8;e[n+f]=255&a,f+=p,a/=256,r-=8);for(o=o<<r|a,l+=r;l>0;e[n+f]=255&o,f+=p,o/=256,l-=8);e[n+f-p]|=128*g};const e_="function"==typeof Symbol&&"function"==typeof Symbol.for?Symbol.for("nodejs.util.inspect.custom"):null;jm=n_;function t_(e){if(e>2147483647)throw new RangeError('The value "'+e+'" is invalid for option "size"');const t=new Uint8Array(e);return Object.setPrototypeOf(t,n_.prototype),t}function n_(e,t,n){if("number"==typeof e){if("string"==typeof t)throw new TypeError('The "string" argument must be of type string. Received type number');return s_(e)}return i_(e,t,n)}function i_(e,t,n){if("string"==typeof e)return function(e,t){"string"==typeof t&&""!==t||(t="utf8");if(!n_.isEncoding(t))throw new TypeError("Unknown encoding: "+t);const n=0|l_(e,t);let i=t_(n);const r=i.write(e,t);r!==n&&(i=i.slice(0,r));return i}(e,t);if(ArrayBuffer.isView(e))return function(e){if(V_(e,Uint8Array)){const t=new Uint8Array(e);return a_(t.buffer,t.byteOffset,t.byteLength)}return o_(e)}(e);if(null==e)throw new TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof e);if(V_(e,ArrayBuffer)||e&&V_(e.buffer,ArrayBuffer))return a_(e,t,n);if("undefined"!=typeof SharedArrayBuffer&&(V_(e,SharedArrayBuffer)||e&&V_(e.buffer,SharedArrayBuffer)))return a_(e,t,n);if("number"==typeof e)throw new TypeError('The "value" argument must not be of type number. Received type number');const i=e.valueOf&&e.valueOf();if(null!=i&&i!==e)return n_.from(i,t,n);const r=function(e){if(n_.isBuffer(e)){const t=0|c_(e.length),n=t_(t);return 0===n.length||e.copy(n,0,0,t),n}if(void 0!==e.length)return"number"!=typeof e.length||H_(e.length)?t_(0):o_(e);if("Buffer"===e.type&&Array.isArray(e.data))return o_(e.data)}(e);if(r)return r;if("undefined"!=typeof Symbol&&null!=Symbol.toPrimitive&&"function"==typeof e[Symbol.toPrimitive])return n_.from(e[Symbol.toPrimitive]("string"),t,n);throw new TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof e)}function r_(e){if("number"!=typeof e)throw new TypeError('"size" argument must be of type number');if(e<0)throw new RangeError('The value "'+e+'" is invalid for option "size"')}function s_(e){return r_(e),t_(e<0?0:0|c_(e))}function o_(e){const t=e.length<0?0:0|c_(e.length),n=t_(t);for(let i=0;i<t;i+=1)n[i]=255&e[i];return n}function a_(e,t,n){if(t<0||e.byteLength<t)throw new RangeError('"offset" is outside of buffer bounds');if(e.byteLength<t+(n||0))throw new RangeError('"length" is outside of buffer bounds');let i;return i=void 0===t&&void 0===n?new Uint8Array(e):void 0===n?new Uint8Array(e,t):new Uint8Array(e,t,n),Object.setPrototypeOf(i,n_.prototype),i}function c_(e){if(e>=2147483647)throw new RangeError("Attempt to allocate Buffer larger than maximum size: 0x"+2147483647..toString(16)+" bytes");return 0|e}function l_(e,t){if(n_.isBuffer(e))return e.length;if(ArrayBuffer.isView(e)||V_(e,ArrayBuffer))return e.byteLength;if("string"!=typeof e)throw new TypeError('The "string" argument must be one of type string, Buffer, or ArrayBuffer. Received type '+typeof e);const n=e.length,i=arguments.length>2&&!0===arguments[2];if(!i&&0===n)return 0;let r=!1;for(;;)switch(t){case"ascii":case"latin1":case"binary":return n;case"utf8":case"utf-8":return B_(e).length;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return 2*n;case"hex":return n>>>1;case"base64":return j_(e).length;default:if(r)return i?-1:B_(e).length;t=(""+t).toLowerCase(),r=!0}}function h_(e,t,n){let i=!1;if((void 0===t||t<0)&&(t=0),t>this.length)return"";if((void 0===n||n>this.length)&&(n=this.length),n<=0)return"";if((n>>>=0)<=(t>>>=0))return"";for(e||(e="utf8");;)switch(e){case"hex":return I_(this,t,n);case"utf8":case"utf-8":return w_(this,t,n);case"ascii":return b_(this,t,n);case"latin1":case"binary":return E_(this,t,n);case"base64":return v_(this,t,n);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return T_(this,t,n);default:if(i)throw new TypeError("Unknown encoding: "+e);e=(e+"").toLowerCase(),i=!0}}function u_(e,t,n){const i=e[t];e[t]=e[n],e[n]=i}function d_(e,t,n,i,r){if(0===e.length)return-1;if("string"==typeof n?(i=n,n=0):n>2147483647?n=2147483647:n<-2147483648&&(n=-2147483648),H_(n=+n)&&(n=r?0:e.length-1),n<0&&(n=e.length+n),n>=e.length){if(r)return-1;n=e.length-1}else if(n<0){if(!r)return-1;n=0}if("string"==typeof t&&(t=n_.from(t,i)),n_.isBuffer(t))return 0===t.length?-1:f_(e,t,n,i,r);if("number"==typeof t)return t&=255,"function"==typeof Uint8Array.prototype.indexOf?r?Uint8Array.prototype.indexOf.call(e,t,n):Uint8Array.prototype.lastIndexOf.call(e,t,n):f_(e,[t],n,i,r);throw new TypeError("val must be string, number or Buffer")}function f_(e,t,n,i,r){let s,o=1,a=e.length,c=t.length;if(void 0!==i&&("ucs2"===(i=String(i).toLowerCase())||"ucs-2"===i||"utf16le"===i||"utf-16le"===i)){if(e.length<2||t.length<2)return-1;o=2,a/=2,c/=2,n/=2}function l(e,t){return 1===o?e[t]:e.readUInt16BE(t*o)}if(r){let i=-1;for(s=n;s<a;s++)if(l(e,s)===l(t,-1===i?0:s-i)){if(-1===i&&(i=s),s-i+1===c)return i*o}else-1!==i&&(s-=s-i),i=-1}else for(n+c>a&&(n=a-c),s=n;s>=0;s--){let n=!0;for(let i=0;i<c;i++)if(l(e,s+i)!==l(t,i)){n=!1;break}if(n)return s}return-1}function p_(e,t,n,i){n=Number(n)||0;const r=e.length-n;i?(i=Number(i))>r&&(i=r):i=r;const s=t.length;let o;for(i>s/2&&(i=s/2),o=0;o<i;++o){const i=parseInt(t.substr(2*o,2),16);if(H_(i))return o;e[n+o]=i}return o}function g_(e,t,n,i){return q_(B_(t,e.length-n),e,n,i)}function m_(e,t,n,i){return q_(function(e){const t=[];for(let n=0;n<e.length;++n)t.push(255&e.charCodeAt(n));return t}(t),e,n,i)}function __(e,t,n,i){return q_(j_(t),e,n,i)}function y_(e,t,n,i){return q_(function(e,t){let n,i,r;const s=[];for(let o=0;o<e.length&&!((t-=2)<0);++o)n=e.charCodeAt(o),i=n>>8,r=n%256,s.push(r),s.push(i);return s}(t,e.length-n),e,n,i)}function v_(e,t,n){return 0===t&&n===e.length?Vm(e):Vm(e.slice(t,n))}function w_(e,t,n){n=Math.min(e.length,n);const i=[];let r=t;for(;r<n;){const t=e[r];let s=null,o=t>239?4:t>223?3:t>191?2:1;if(r+o<=n){let n,i,a,c;switch(o){case 1:t<128&&(s=t);break;case 2:n=e[r+1],128==(192&n)&&(c=(31&t)<<6|63&n,c>127&&(s=c));break;case 3:n=e[r+1],i=e[r+2],128==(192&n)&&128==(192&i)&&(c=(15&t)<<12|(63&n)<<6|63&i,c>2047&&(c<55296||c>57343)&&(s=c));break;case 4:n=e[r+1],i=e[r+2],a=e[r+3],128==(192&n)&&128==(192&i)&&128==(192&a)&&(c=(15&t)<<18|(63&n)<<12|(63&i)<<6|63&a,c>65535&&c<1114112&&(s=c))}}null===s?(s=65533,o=1):s>65535&&(s-=65536,i.push(s>>>10&1023|55296),s=56320|1023&s),i.push(s),r+=o}return function(e){const t=e.length;if(t<=4096)return String.fromCharCode.apply(String,e);let n="",i=0;for(;i<t;)n+=String.fromCharCode.apply(String,e.slice(i,i+=4096));return n}(i)}n_.TYPED_ARRAY_SUPPORT=function(){try{const e=new Uint8Array(1),t={foo:function(){return 42}};return Object.setPrototypeOf(t,Uint8Array.prototype),Object.setPrototypeOf(e,t),42===e.foo()}catch(e){return!1}}(),n_.TYPED_ARRAY_SUPPORT||"undefined"==typeof console||"function"!=typeof console.error||console.error("This browser lacks typed array (Uint8Array) support which is required by `buffer` v5.x. Use `buffer` v4.x if you require old browser support."),Object.defineProperty(n_.prototype,"parent",{enumerable:!0,get:function(){if(n_.isBuffer(this))return this.buffer}}),Object.defineProperty(n_.prototype,"offset",{enumerable:!0,get:function(){if(n_.isBuffer(this))return this.byteOffset}}),n_.poolSize=8192,n_.from=function(e,t,n){return i_(e,t,n)},Object.setPrototypeOf(n_.prototype,Uint8Array.prototype),Object.setPrototypeOf(n_,Uint8Array),n_.alloc=function(e,t,n){return function(e,t,n){return r_(e),e<=0?t_(e):void 0!==t?"string"==typeof n?t_(e).fill(t,n):t_(e).fill(t):t_(e)}(e,t,n)},n_.allocUnsafe=function(e){return s_(e)},n_.allocUnsafeSlow=function(e){return s_(e)},n_.isBuffer=function(e){return null!=e&&!0===e._isBuffer&&e!==n_.prototype},n_.compare=function(e,t){if(V_(e,Uint8Array)&&(e=n_.from(e,e.offset,e.byteLength)),V_(t,Uint8Array)&&(t=n_.from(t,t.offset,t.byteLength)),!n_.isBuffer(e)||!n_.isBuffer(t))throw new TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');if(e===t)return 0;let n=e.length,i=t.length;for(let r=0,s=Math.min(n,i);r<s;++r)if(e[r]!==t[r]){n=e[r],i=t[r];break}return n<i?-1:i<n?1:0},n_.isEncoding=function(e){switch(String(e).toLowerCase()){case"hex":case"utf8":case"utf-8":case"ascii":case"latin1":case"binary":case"base64":case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return!0;default:return!1}},n_.concat=function(e,t){if(!Array.isArray(e))throw new TypeError('"list" argument must be an Array of Buffers');if(0===e.length)return n_.alloc(0);let n;if(void 0===t)for(t=0,n=0;n<e.length;++n)t+=e[n].length;const i=n_.allocUnsafe(t);let r=0;for(n=0;n<e.length;++n){let t=e[n];if(V_(t,Uint8Array))r+t.length>i.length?(n_.isBuffer(t)||(t=n_.from(t)),t.copy(i,r)):Uint8Array.prototype.set.call(i,t,r);else{if(!n_.isBuffer(t))throw new TypeError('"list" argument must be an Array of Buffers');t.copy(i,r)}r+=t.length}return i},n_.byteLength=l_,n_.prototype._isBuffer=!0,n_.prototype.swap16=function(){const e=this.length;if(e%2!=0)throw new RangeError("Buffer size must be a multiple of 16-bits");for(let t=0;t<e;t+=2)u_(this,t,t+1);return this},n_.prototype.swap32=function(){const e=this.length;if(e%4!=0)throw new RangeError("Buffer size must be a multiple of 32-bits");for(let t=0;t<e;t+=4)u_(this,t,t+3),u_(this,t+1,t+2);return this},n_.prototype.swap64=function(){const e=this.length;if(e%8!=0)throw new RangeError("Buffer size must be a multiple of 64-bits");for(let t=0;t<e;t+=8)u_(this,t,t+7),u_(this,t+1,t+6),u_(this,t+2,t+5),u_(this,t+3,t+4);return this},n_.prototype.toString=function(){const e=this.length;return 0===e?"":0===arguments.length?w_(this,0,e):h_.apply(this,arguments)},n_.prototype.toLocaleString=n_.prototype.toString,n_.prototype.equals=function(e){if(!n_.isBuffer(e))throw new TypeError("Argument must be a Buffer");return this===e||0===n_.compare(this,e)},n_.prototype.inspect=function(){let e="";return e=this.toString("hex",0,50).replace(/(.{2})/g,"$1 ").trim(),this.length>50&&(e+=" ... "),"<Buffer "+e+">"},e_&&(n_.prototype[e_]=n_.prototype.inspect),n_.prototype.compare=function(e,t,n,i,r){if(V_(e,Uint8Array)&&(e=n_.from(e,e.offset,e.byteLength)),!n_.isBuffer(e))throw new TypeError('The "target" argument must be one of type Buffer or Uint8Array. Received type '+typeof e);if(void 0===t&&(t=0),void 0===n&&(n=e?e.length:0),void 0===i&&(i=0),void 0===r&&(r=this.length),t<0||n>e.length||i<0||r>this.length)throw new RangeError("out of range index");if(i>=r&&t>=n)return 0;if(i>=r)return-1;if(t>=n)return 1;if(this===e)return 0;let s=(r>>>=0)-(i>>>=0),o=(n>>>=0)-(t>>>=0);const a=Math.min(s,o),c=this.slice(i,r),l=e.slice(t,n);for(let e=0;e<a;++e)if(c[e]!==l[e]){s=c[e],o=l[e];break}return s<o?-1:o<s?1:0},n_.prototype.includes=function(e,t,n){return-1!==this.indexOf(e,t,n)},n_.prototype.indexOf=function(e,t,n){return d_(this,e,t,n,!0)},n_.prototype.lastIndexOf=function(e,t,n){return d_(this,e,t,n,!1)},n_.prototype.write=function(e,t,n,i){if(void 0===t)i="utf8",n=this.length,t=0;else if(void 0===n&&"string"==typeof t)i=t,n=this.length,t=0;else{if(!isFinite(t))throw new Error("Buffer.write(string, encoding, offset[, length]) is no longer supported");t>>>=0,isFinite(n)?(n>>>=0,void 0===i&&(i="utf8")):(i=n,n=void 0)}const r=this.length-t;if((void 0===n||n>r)&&(n=r),e.length>0&&(n<0||t<0)||t>this.length)throw new RangeError("Attempt to write outside buffer bounds");i||(i="utf8");let s=!1;for(;;)switch(i){case"hex":return p_(this,e,t,n);case"utf8":case"utf-8":return g_(this,e,t,n);case"ascii":case"latin1":case"binary":return m_(this,e,t,n);case"base64":return __(this,e,t,n);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return y_(this,e,t,n);default:if(s)throw new TypeError("Unknown encoding: "+i);i=(""+i).toLowerCase(),s=!0}},n_.prototype.toJSON=function(){return{type:"Buffer",data:Array.prototype.slice.call(this._arr||this,0)}};function b_(e,t,n){let i="";n=Math.min(e.length,n);for(let r=t;r<n;++r)i+=String.fromCharCode(127&e[r]);return i}function E_(e,t,n){let i="";n=Math.min(e.length,n);for(let r=t;r<n;++r)i+=String.fromCharCode(e[r]);return i}function I_(e,t,n){const i=e.length;(!t||t<0)&&(t=0),(!n||n<0||n>i)&&(n=i);let r="";for(let i=t;i<n;++i)r+=$_[e[i]];return r}function T_(e,t,n){const i=e.slice(t,n);let r="";for(let e=0;e<i.length-1;e+=2)r+=String.fromCharCode(i[e]+256*i[e+1]);return r}function C_(e,t,n){if(e%1!=0||e<0)throw new RangeError("offset is not uint");if(e+t>n)throw new RangeError("Trying to access beyond buffer length")}function S_(e,t,n,i,r,s){if(!n_.isBuffer(e))throw new TypeError('"buffer" argument must be a Buffer instance');if(t>r||t<s)throw new RangeError('"value" argument is out of bounds');if(n+i>e.length)throw new RangeError("Index out of range")}function k_(e,t,n,i,r){x_(t,i,r,e,n,7);let s=Number(t&BigInt(4294967295));e[n++]=s,s>>=8,e[n++]=s,s>>=8,e[n++]=s,s>>=8,e[n++]=s;let o=Number(t>>BigInt(32)&BigInt(4294967295));return e[n++]=o,o>>=8,e[n++]=o,o>>=8,e[n++]=o,o>>=8,e[n++]=o,n}function R_(e,t,n,i,r){x_(t,i,r,e,n,7);let s=Number(t&BigInt(4294967295));e[n+7]=s,s>>=8,e[n+6]=s,s>>=8,e[n+5]=s,s>>=8,e[n+4]=s;let o=Number(t>>BigInt(32)&BigInt(4294967295));return e[n+3]=o,o>>=8,e[n+2]=o,o>>=8,e[n+1]=o,o>>=8,e[n]=o,n+8}function A_(e,t,n,i,r,s){if(n+i>e.length)throw new RangeError("Index out of range");if(n<0)throw new RangeError("Index out of range")}function N_(e,t,n,i,r){return t=+t,n>>>=0,r||A_(e,0,n,4),zm(e,t,n,i,23,4),n+4}function O_(e,t,n,i,r){return t=+t,n>>>=0,r||A_(e,0,n,8),zm(e,t,n,i,52,8),n+8}n_.prototype.slice=function(e,t){const n=this.length;(e=~~e)<0?(e+=n)<0&&(e=0):e>n&&(e=n),(t=void 0===t?n:~~t)<0?(t+=n)<0&&(t=0):t>n&&(t=n),t<e&&(t=e);const i=this.subarray(e,t);return Object.setPrototypeOf(i,n_.prototype),i},n_.prototype.readUintLE=n_.prototype.readUIntLE=function(e,t,n){e>>>=0,t>>>=0,n||C_(e,t,this.length);let i=this[e],r=1,s=0;for(;++s<t&&(r*=256);)i+=this[e+s]*r;return i},n_.prototype.readUintBE=n_.prototype.readUIntBE=function(e,t,n){e>>>=0,t>>>=0,n||C_(e,t,this.length);let i=this[e+--t],r=1;for(;t>0&&(r*=256);)i+=this[e+--t]*r;return i},n_.prototype.readUint8=n_.prototype.readUInt8=function(e,t){return e>>>=0,t||C_(e,1,this.length),this[e]},n_.prototype.readUint16LE=n_.prototype.readUInt16LE=function(e,t){return e>>>=0,t||C_(e,2,this.length),this[e]|this[e+1]<<8},n_.prototype.readUint16BE=n_.prototype.readUInt16BE=function(e,t){return e>>>=0,t||C_(e,2,this.length),this[e]<<8|this[e+1]},n_.prototype.readUint32LE=n_.prototype.readUInt32LE=function(e,t){return e>>>=0,t||C_(e,4,this.length),(this[e]|this[e+1]<<8|this[e+2]<<16)+16777216*this[e+3]},n_.prototype.readUint32BE=n_.prototype.readUInt32BE=function(e,t){return e>>>=0,t||C_(e,4,this.length),16777216*this[e]+(this[e+1]<<16|this[e+2]<<8|this[e+3])},n_.prototype.readBigUInt64LE=z_((function(e){M_(e>>>=0,"offset");const t=this[e],n=this[e+7];void 0!==t&&void 0!==n||U_(e,this.length-8);const i=t+256*this[++e]+65536*this[++e]+this[++e]*2**24,r=this[++e]+256*this[++e]+65536*this[++e]+n*2**24;return BigInt(i)+(BigInt(r)<<BigInt(32))})),n_.prototype.readBigUInt64BE=z_((function(e){M_(e>>>=0,"offset");const t=this[e],n=this[e+7];void 0!==t&&void 0!==n||U_(e,this.length-8);const i=t*2**24+65536*this[++e]+256*this[++e]+this[++e],r=this[++e]*2**24+65536*this[++e]+256*this[++e]+n;return(BigInt(i)<<BigInt(32))+BigInt(r)})),n_.prototype.readIntLE=function(e,t,n){e>>>=0,t>>>=0,n||C_(e,t,this.length);let i=this[e],r=1,s=0;for(;++s<t&&(r*=256);)i+=this[e+s]*r;return r*=128,i>=r&&(i-=Math.pow(2,8*t)),i},n_.prototype.readIntBE=function(e,t,n){e>>>=0,t>>>=0,n||C_(e,t,this.length);let i=t,r=1,s=this[e+--i];for(;i>0&&(r*=256);)s+=this[e+--i]*r;return r*=128,s>=r&&(s-=Math.pow(2,8*t)),s},n_.prototype.readInt8=function(e,t){return e>>>=0,t||C_(e,1,this.length),128&this[e]?-1*(255-this[e]+1):this[e]},n_.prototype.readInt16LE=function(e,t){e>>>=0,t||C_(e,2,this.length);const n=this[e]|this[e+1]<<8;return 32768&n?4294901760|n:n},n_.prototype.readInt16BE=function(e,t){e>>>=0,t||C_(e,2,this.length);const n=this[e+1]|this[e]<<8;return 32768&n?4294901760|n:n},n_.prototype.readInt32LE=function(e,t){return e>>>=0,t||C_(e,4,this.length),this[e]|this[e+1]<<8|this[e+2]<<16|this[e+3]<<24},n_.prototype.readInt32BE=function(e,t){return e>>>=0,t||C_(e,4,this.length),this[e]<<24|this[e+1]<<16|this[e+2]<<8|this[e+3]},n_.prototype.readBigInt64LE=z_((function(e){M_(e>>>=0,"offset");const t=this[e],n=this[e+7];void 0!==t&&void 0!==n||U_(e,this.length-8);const i=this[e+4]+256*this[e+5]+65536*this[e+6]+(n<<24);return(BigInt(i)<<BigInt(32))+BigInt(t+256*this[++e]+65536*this[++e]+this[++e]*2**24)})),n_.prototype.readBigInt64BE=z_((function(e){M_(e>>>=0,"offset");const t=this[e],n=this[e+7];void 0!==t&&void 0!==n||U_(e,this.length-8);const i=(t<<24)+65536*this[++e]+256*this[++e]+this[++e];return(BigInt(i)<<BigInt(32))+BigInt(this[++e]*2**24+65536*this[++e]+256*this[++e]+n)})),n_.prototype.readFloatLE=function(e,t){return e>>>=0,t||C_(e,4,this.length),$m(this,e,!0,23,4)},n_.prototype.readFloatBE=function(e,t){return e>>>=0,t||C_(e,4,this.length),$m(this,e,!1,23,4)},n_.prototype.readDoubleLE=function(e,t){return e>>>=0,t||C_(e,8,this.length),$m(this,e,!0,52,8)},n_.prototype.readDoubleBE=function(e,t){return e>>>=0,t||C_(e,8,this.length),$m(this,e,!1,52,8)},n_.prototype.writeUintLE=n_.prototype.writeUIntLE=function(e,t,n,i){if(e=+e,t>>>=0,n>>>=0,!i){S_(this,e,t,n,Math.pow(2,8*n)-1,0)}let r=1,s=0;for(this[t]=255&e;++s<n&&(r*=256);)this[t+s]=e/r&255;return t+n},n_.prototype.writeUintBE=n_.prototype.writeUIntBE=function(e,t,n,i){if(e=+e,t>>>=0,n>>>=0,!i){S_(this,e,t,n,Math.pow(2,8*n)-1,0)}let r=n-1,s=1;for(this[t+r]=255&e;--r>=0&&(s*=256);)this[t+r]=e/s&255;return t+n},n_.prototype.writeUint8=n_.prototype.writeUInt8=function(e,t,n){return e=+e,t>>>=0,n||S_(this,e,t,1,255,0),this[t]=255&e,t+1},n_.prototype.writeUint16LE=n_.prototype.writeUInt16LE=function(e,t,n){return e=+e,t>>>=0,n||S_(this,e,t,2,65535,0),this[t]=255&e,this[t+1]=e>>>8,t+2},n_.prototype.writeUint16BE=n_.prototype.writeUInt16BE=function(e,t,n){return e=+e,t>>>=0,n||S_(this,e,t,2,65535,0),this[t]=e>>>8,this[t+1]=255&e,t+2},n_.prototype.writeUint32LE=n_.prototype.writeUInt32LE=function(e,t,n){return e=+e,t>>>=0,n||S_(this,e,t,4,4294967295,0),this[t+3]=e>>>24,this[t+2]=e>>>16,this[t+1]=e>>>8,this[t]=255&e,t+4},n_.prototype.writeUint32BE=n_.prototype.writeUInt32BE=function(e,t,n){return e=+e,t>>>=0,n||S_(this,e,t,4,4294967295,0),this[t]=e>>>24,this[t+1]=e>>>16,this[t+2]=e>>>8,this[t+3]=255&e,t+4},n_.prototype.writeBigUInt64LE=z_((function(e,t=0){return k_(this,e,t,BigInt(0),BigInt("0xffffffffffffffff"))})),n_.prototype.writeBigUInt64BE=z_((function(e,t=0){return R_(this,e,t,BigInt(0),BigInt("0xffffffffffffffff"))})),n_.prototype.writeIntLE=function(e,t,n,i){if(e=+e,t>>>=0,!i){const i=Math.pow(2,8*n-1);S_(this,e,t,n,i-1,-i)}let r=0,s=1,o=0;for(this[t]=255&e;++r<n&&(s*=256);)e<0&&0===o&&0!==this[t+r-1]&&(o=1),this[t+r]=(e/s>>0)-o&255;return t+n},n_.prototype.writeIntBE=function(e,t,n,i){if(e=+e,t>>>=0,!i){const i=Math.pow(2,8*n-1);S_(this,e,t,n,i-1,-i)}let r=n-1,s=1,o=0;for(this[t+r]=255&e;--r>=0&&(s*=256);)e<0&&0===o&&0!==this[t+r+1]&&(o=1),this[t+r]=(e/s>>0)-o&255;return t+n},n_.prototype.writeInt8=function(e,t,n){return e=+e,t>>>=0,n||S_(this,e,t,1,127,-128),e<0&&(e=255+e+1),this[t]=255&e,t+1},n_.prototype.writeInt16LE=function(e,t,n){return e=+e,t>>>=0,n||S_(this,e,t,2,32767,-32768),this[t]=255&e,this[t+1]=e>>>8,t+2},n_.prototype.writeInt16BE=function(e,t,n){return e=+e,t>>>=0,n||S_(this,e,t,2,32767,-32768),this[t]=e>>>8,this[t+1]=255&e,t+2},n_.prototype.writeInt32LE=function(e,t,n){return e=+e,t>>>=0,n||S_(this,e,t,4,2147483647,-2147483648),this[t]=255&e,this[t+1]=e>>>8,this[t+2]=e>>>16,this[t+3]=e>>>24,t+4},n_.prototype.writeInt32BE=function(e,t,n){return e=+e,t>>>=0,n||S_(this,e,t,4,2147483647,-2147483648),e<0&&(e=4294967295+e+1),this[t]=e>>>24,this[t+1]=e>>>16,this[t+2]=e>>>8,this[t+3]=255&e,t+4},n_.prototype.writeBigInt64LE=z_((function(e,t=0){return k_(this,e,t,-BigInt("0x8000000000000000"),BigInt("0x7fffffffffffffff"))})),n_.prototype.writeBigInt64BE=z_((function(e,t=0){return R_(this,e,t,-BigInt("0x8000000000000000"),BigInt("0x7fffffffffffffff"))})),n_.prototype.writeFloatLE=function(e,t,n){return N_(this,e,t,!0,n)},n_.prototype.writeFloatBE=function(e,t,n){return N_(this,e,t,!1,n)},n_.prototype.writeDoubleLE=function(e,t,n){return O_(this,e,t,!0,n)},n_.prototype.writeDoubleBE=function(e,t,n){return O_(this,e,t,!1,n)},n_.prototype.copy=function(e,t,n,i){if(!n_.isBuffer(e))throw new TypeError("argument should be a Buffer");if(n||(n=0),i||0===i||(i=this.length),t>=e.length&&(t=e.length),t||(t=0),i>0&&i<n&&(i=n),i===n)return 0;if(0===e.length||0===this.length)return 0;if(t<0)throw new RangeError("targetStart out of bounds");if(n<0||n>=this.length)throw new RangeError("Index out of range");if(i<0)throw new RangeError("sourceEnd out of bounds");i>this.length&&(i=this.length),e.length-t<i-n&&(i=e.length-t+n);const r=i-n;return this===e&&"function"==typeof Uint8Array.prototype.copyWithin?this.copyWithin(t,n,i):Uint8Array.prototype.set.call(e,this.subarray(n,i),t),r},n_.prototype.fill=function(e,t,n,i){if("string"==typeof e){if("string"==typeof t?(i=t,t=0,n=this.length):"string"==typeof n&&(i=n,n=this.length),void 0!==i&&"string"!=typeof i)throw new TypeError("encoding must be a string");if("string"==typeof i&&!n_.isEncoding(i))throw new TypeError("Unknown encoding: "+i);if(1===e.length){const t=e.charCodeAt(0);("utf8"===i&&t<128||"latin1"===i)&&(e=t)}}else"number"==typeof e?e&=255:"boolean"==typeof e&&(e=Number(e));if(t<0||this.length<t||this.length<n)throw new RangeError("Out of range index");if(n<=t)return this;let r;if(t>>>=0,n=void 0===n?this.length:n>>>0,e||(e=0),"number"==typeof e)for(r=t;r<n;++r)this[r]=e;else{const s=n_.isBuffer(e)?e:n_.from(e,i),o=s.length;if(0===o)throw new TypeError('The value "'+e+'" is invalid for argument "value"');for(r=0;r<n-t;++r)this[r+t]=s[r%o]}return this};const P_={};function L_(e,t,n){P_[e]=class extends n{constructor(){super(),Object.defineProperty(this,"message",{value:t.apply(this,arguments),writable:!0,configurable:!0}),this.name=`${this.name} [${e}]`,this.stack,delete this.name}get code(){return e}set code(e){Object.defineProperty(this,"code",{configurable:!0,enumerable:!0,value:e,writable:!0})}toString(){return`${this.name} [${e}]: ${this.message}`}}}function D_(e){let t="",n=e.length;const i="-"===e[0]?1:0;for(;n>=i+4;n-=3)t=`_${e.slice(n-3,n)}${t}`;return`${e.slice(0,n)}${t}`}function x_(e,t,n,i,r,s){if(e>n||e<t){const i="bigint"==typeof t?"n":"";let r;throw r=s>3?0===t||t===BigInt(0)?`>= 0${i} and < 2${i} ** ${8*(s+1)}${i}`:`>= -(2${i} ** ${8*(s+1)-1}${i}) and < 2 ** ${8*(s+1)-1}${i}`:`>= ${t}${i} and <= ${n}${i}`,new P_.ERR_OUT_OF_RANGE("value",r,e)}!function(e,t,n){M_(t,"offset"),void 0!==e[t]&&void 0!==e[t+n]||U_(t,e.length-(n+1))}(i,r,s)}function M_(e,t){if("number"!=typeof e)throw new P_.ERR_INVALID_ARG_TYPE(t,"number",e)}function U_(e,t,n){if(Math.floor(e)!==e)throw M_(e,n),new P_.ERR_OUT_OF_RANGE(n||"offset","an integer",e);if(t<0)throw new P_.ERR_BUFFER_OUT_OF_BOUNDS;throw new P_.ERR_OUT_OF_RANGE(n||"offset",`>= ${n?1:0} and <= ${t}`,e)}L_("ERR_BUFFER_OUT_OF_BOUNDS",(function(e){return e?`${e} is outside of buffer bounds`:"Attempt to access memory outside buffer bounds"}),RangeError),L_("ERR_INVALID_ARG_TYPE",(function(e,t){return`The "${e}" argument must be of type number. Received type ${typeof t}`}),TypeError),L_("ERR_OUT_OF_RANGE",(function(e,t,n){let i=`The value of "${e}" is out of range.`,r=n;return Number.isInteger(n)&&Math.abs(n)>2**32?r=D_(String(n)):"bigint"==typeof n&&(r=String(n),(n>BigInt(2)**BigInt(32)||n<-(BigInt(2)**BigInt(32)))&&(r=D_(r)),r+="n"),i+=` It must be ${t}. Received ${r}`,i}),RangeError);const F_=/[^+/0-9A-Za-z-_]/g;function B_(e,t){let n;t=t||1/0;const i=e.length;let r=null;const s=[];for(let o=0;o<i;++o){if(n=e.charCodeAt(o),n>55295&&n<57344){if(!r){if(n>56319){(t-=3)>-1&&s.push(239,191,189);continue}if(o+1===i){(t-=3)>-1&&s.push(239,191,189);continue}r=n;continue}if(n<56320){(t-=3)>-1&&s.push(239,191,189),r=n;continue}n=65536+(r-55296<<10|n-56320)}else r&&(t-=3)>-1&&s.push(239,191,189);if(r=null,n<128){if((t-=1)<0)break;s.push(n)}else if(n<2048){if((t-=2)<0)break;s.push(n>>6|192,63&n|128)}else if(n<65536){if((t-=3)<0)break;s.push(n>>12|224,n>>6&63|128,63&n|128)}else{if(!(n<1114112))throw new Error("Invalid code point");if((t-=4)<0)break;s.push(n>>18|240,n>>12&63|128,n>>6&63|128,63&n|128)}}return s}function j_(e){return qm(function(e){if((e=(e=e.split("=")[0]).trim().replace(F_,"")).length<2)return"";for(;e.length%4!=0;)e+="=";return e}(e))}function q_(e,t,n,i){let r;for(r=0;r<i&&!(r+n>=t.length||r>=e.length);++r)t[r+n]=e[r];return r}function V_(e,t){return e instanceof t||null!=e&&null!=e.constructor&&null!=e.constructor.name&&e.constructor.name===t.name}function H_(e){return e!=e}const $_=function(){const e="0123456789abcdef",t=new Array(256);for(let n=0;n<16;++n){const i=16*n;for(let r=0;r<16;++r)t[i+r]=e[n]+e[r]}return t}();function z_(e){return"undefined"==typeof BigInt?W_:e}function W_(){throw new Error("BigInt not supported")}var K_=jm;function G_(e){return Mm.isPlainObject(e)||Mm.isArray(e)}function Y_(e){return Mm.endsWith(e,"[]")?e.slice(0,-2):e}function J_(e,t,n){return e?e.concat(t).map((function(e,t){return e=Y_(e),!n&&t?"["+e+"]":e})).join(n?".":""):t}const X_=Mm.toFlatObject(Mm,{},null,(function(e){return/^is[A-Z]/.test(e)}));var Q_=function(e,t,n){if(!Mm.isObject(e))throw new TypeError("target must be an object");t=t||new FormData;const i=(n=Mm.toFlatObject(n,{metaTokens:!0,dots:!1,indexes:!1},!1,(function(e,t){return!Mm.isUndefined(t[e])}))).metaTokens,r=n.visitor||l,s=n.dots,o=n.indexes,a=(n.Blob||"undefined"!=typeof Blob&&Blob)&&Mm.isSpecCompliantForm(t);if(!Mm.isFunction(r))throw new TypeError("visitor must be a function");function c(e){if(null===e)return"";if(Mm.isDate(e))return e.toISOString();if(!a&&Mm.isBlob(e))throw new Hm("Blob is not supported. Use a Buffer instead.");return Mm.isArrayBuffer(e)||Mm.isTypedArray(e)?a&&"function"==typeof Blob?new Blob([e]):K_.from(e):e}function l(e,n,r){let a=e;if(e&&!r&&"object"==typeof e)if(Mm.endsWith(n,"{}"))n=i?n:n.slice(0,-2),e=JSON.stringify(e);else if(Mm.isArray(e)&&function(e){return Mm.isArray(e)&&!e.some(G_)}(e)||(Mm.isFileList(e)||Mm.endsWith(n,"[]"))&&(a=Mm.toArray(e)))return n=Y_(n),a.forEach((function(e,i){!Mm.isUndefined(e)&&null!==e&&t.append(!0===o?J_([n],i,s):null===o?n:n+"[]",c(e))})),!1;return!!G_(e)||(t.append(J_(r,n,s),c(e)),!1)}const h=[],u=Object.assign(X_,{defaultVisitor:l,convertValue:c,isVisitable:G_});if(!Mm.isObject(e))throw new TypeError("data must be an object");return function e(n,i){if(!Mm.isUndefined(n)){if(-1!==h.indexOf(n))throw Error("Circular reference detected in "+i.join("."));h.push(n),Mm.forEach(n,(function(n,s){!0===(!(Mm.isUndefined(n)||null===n)&&r.call(t,n,Mm.isString(s)?s.trim():s,i,u))&&e(n,i?i.concat(s):[s])})),h.pop()}}(e),t};function Z_(e){const t={"!":"%21","'":"%27","(":"%28",")":"%29","~":"%7E","%20":"+","%00":"\0"};return encodeURIComponent(e).replace(/[!'()~]|%20|%00/g,(function(e){return t[e]}))}function ey(e,t){this._pairs=[],e&&Q_(e,this,t)}const ty=ey.prototype;ty.append=function(e,t){this._pairs.push([e,t])},ty.toString=function(e){const t=e?function(t){return e.call(this,t,Z_)}:Z_;return this._pairs.map((function(e){return t(e[0])+"="+t(e[1])}),"").join("&")};var ny=ey;function iy(e){return encodeURIComponent(e).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}function ry(e,t,n){if(!t)return e;const i=n&&n.encode||iy,r=n&&n.serialize;let s;if(s=r?r(t,n):Mm.isURLSearchParams(t)?t.toString():new ny(t,n).toString(i),s){const t=e.indexOf("#");-1!==t&&(e=e.slice(0,t)),e+=(-1===e.indexOf("?")?"?":"&")+s}return e}var sy=class{constructor(){this.handlers=[]}use(e,t,n){return this.handlers.push({fulfilled:e,rejected:t,synchronous:!!n&&n.synchronous,runWhen:n?n.runWhen:null}),this.handlers.length-1}eject(e){this.handlers[e]&&(this.handlers[e]=null)}clear(){this.handlers&&(this.handlers=[])}forEach(e){Mm.forEach(this.handlers,(function(t){null!==t&&e(t)}))}},oy={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1};var ay={isBrowser:!0,classes:{URLSearchParams:"undefined"!=typeof URLSearchParams?URLSearchParams:ny,FormData:"undefined"!=typeof FormData?FormData:null,Blob:"undefined"!=typeof Blob?Blob:null},isStandardBrowserEnv:(()=>{let e;return("undefined"==typeof navigator||"ReactNative"!==(e=navigator.product)&&"NativeScript"!==e&&"NS"!==e)&&("undefined"!=typeof window&&"undefined"!=typeof document)})(),isStandardBrowserWebWorkerEnv:"undefined"!=typeof WorkerGlobalScope&&self instanceof WorkerGlobalScope&&"function"==typeof self.importScripts,protocols:["http","https","file","blob","url","data"]};function cy(e,t){return Q_(e,new ay.classes.URLSearchParams,Object.assign({visitor:function(e,t,n,i){return ay.isNode&&Mm.isBuffer(e)?(this.append(t,e.toString("base64")),!1):i.defaultVisitor.apply(this,arguments)}},t))}var ly=function(e){function t(e,n,i,r){let s=e[r++];const o=Number.isFinite(+s),a=r>=e.length;if(s=!s&&Mm.isArray(i)?i.length:s,a)return Mm.hasOwnProp(i,s)?i[s]=[i[s],n]:i[s]=n,!o;i[s]&&Mm.isObject(i[s])||(i[s]=[]);return t(e,n,i[s],r)&&Mm.isArray(i[s])&&(i[s]=function(e){const t={},n=Object.keys(e);let i;const r=n.length;let s;for(i=0;i<r;i++)s=n[i],t[s]=e[s];return t}(i[s])),!o}if(Mm.isFormData(e)&&Mm.isFunction(e.entries)){const n={};return Mm.forEachEntry(e,((e,i)=>{t(function(e){return Mm.matchAll(/\w+|\[(\w*)]/g,e).map((e=>"[]"===e[0]?"":e[1]||e[0]))}(e),i,n,0)})),n}return null};const hy={transitional:oy,adapter:ay.isNode?"http":"xhr",transformRequest:[function(e,t){const n=t.getContentType()||"",i=n.indexOf("application/json")>-1,r=Mm.isObject(e);r&&Mm.isHTMLForm(e)&&(e=new FormData(e));if(Mm.isFormData(e))return i&&i?JSON.stringify(ly(e)):e;if(Mm.isArrayBuffer(e)||Mm.isBuffer(e)||Mm.isStream(e)||Mm.isFile(e)||Mm.isBlob(e))return e;if(Mm.isArrayBufferView(e))return e.buffer;if(Mm.isURLSearchParams(e))return t.setContentType("application/x-www-form-urlencoded;charset=utf-8",!1),e.toString();let s;if(r){if(n.indexOf("application/x-www-form-urlencoded")>-1)return cy(e,this.formSerializer).toString();if((s=Mm.isFileList(e))||n.indexOf("multipart/form-data")>-1){const t=this.env&&this.env.FormData;return Q_(s?{"files[]":e}:e,t&&new t,this.formSerializer)}}return r||i?(t.setContentType("application/json",!1),function(e,t,n){if(Mm.isString(e))try{return(t||JSON.parse)(e),Mm.trim(e)}catch(e){if("SyntaxError"!==e.name)throw e}return(n||JSON.stringify)(e)}(e)):e}],transformResponse:[function(e){const t=this.transitional||hy.transitional,n=t&&t.forcedJSONParsing,i="json"===this.responseType;if(e&&Mm.isString(e)&&(n&&!this.responseType||i)){const n=!(t&&t.silentJSONParsing)&&i;try{return JSON.parse(e)}catch(e){if(n){if("SyntaxError"===e.name)throw Hm.from(e,Hm.ERR_BAD_RESPONSE,this,null,this.response);throw e}}}return e}],timeout:0,xsrfCookieName:"XSRF-TOKEN",xsrfHeaderName:"X-XSRF-TOKEN",maxContentLength:-1,maxBodyLength:-1,env:{FormData:ay.classes.FormData,Blob:ay.classes.Blob},validateStatus:function(e){return e>=200&&e<300},headers:{common:{Accept:"application/json, text/plain, */*","Content-Type":void 0}}};Mm.forEach(["delete","get","head","post","put","patch"],(e=>{hy.headers[e]={}}));var uy=hy;const dy=Mm.toObjectSet(["age","authorization","content-length","content-type","etag","expires","from","host","if-modified-since","if-unmodified-since","last-modified","location","max-forwards","proxy-authorization","referer","retry-after","user-agent"]);var fy=e=>{const t={};let n,i,r;return e&&e.split("\n").forEach((function(e){r=e.indexOf(":"),n=e.substring(0,r).trim().toLowerCase(),i=e.substring(r+1).trim(),!n||t[n]&&dy[n]||("set-cookie"===n?t[n]?t[n].push(i):t[n]=[i]:t[n]=t[n]?t[n]+", "+i:i)})),t};const py=Symbol("internals");function gy(e){return e&&String(e).trim().toLowerCase()}function my(e){return!1===e||null==e?e:Mm.isArray(e)?e.map(my):String(e)}function _y(e,t,n,i,r){return Mm.isFunction(i)?i.call(this,t,n):(r&&(t=n),Mm.isString(t)?Mm.isString(i)?-1!==t.indexOf(i):Mm.isRegExp(i)?i.test(t):void 0:void 0)}class yy{constructor(e){e&&this.set(e)}set(e,t,n){const i=this;function r(e,t,n){const r=gy(t);if(!r)throw new Error("header name must be a non-empty string");const s=Mm.findKey(i,r);(!s||void 0===i[s]||!0===n||void 0===n&&!1!==i[s])&&(i[s||t]=my(e))}const s=(e,t)=>Mm.forEach(e,((e,n)=>r(e,n,t)));return Mm.isPlainObject(e)||e instanceof this.constructor?s(e,t):Mm.isString(e)&&(e=e.trim())&&!/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(e.trim())?s(fy(e),t):null!=e&&r(t,e,n),this}get(e,t){if(e=gy(e)){const n=Mm.findKey(this,e);if(n){const e=this[n];if(!t)return e;if(!0===t)return function(e){const t=Object.create(null),n=/([^\s,;=]+)\s*(?:=\s*([^,;]+))?/g;let i;for(;i=n.exec(e);)t[i[1]]=i[2];return t}(e);if(Mm.isFunction(t))return t.call(this,e,n);if(Mm.isRegExp(t))return t.exec(e);throw new TypeError("parser must be boolean|regexp|function")}}}has(e,t){if(e=gy(e)){const n=Mm.findKey(this,e);return!(!n||void 0===this[n]||t&&!_y(0,this[n],n,t))}return!1}delete(e,t){const n=this;let i=!1;function r(e){if(e=gy(e)){const r=Mm.findKey(n,e);!r||t&&!_y(0,n[r],r,t)||(delete n[r],i=!0)}}return Mm.isArray(e)?e.forEach(r):r(e),i}clear(e){const t=Object.keys(this);let n=t.length,i=!1;for(;n--;){const r=t[n];e&&!_y(0,this[r],r,e,!0)||(delete this[r],i=!0)}return i}normalize(e){const t=this,n={};return Mm.forEach(this,((i,r)=>{const s=Mm.findKey(n,r);if(s)return t[s]=my(i),void delete t[r];const o=e?function(e){return e.trim().toLowerCase().replace(/([a-z\d])(\w*)/g,((e,t,n)=>t.toUpperCase()+n))}(r):String(r).trim();o!==r&&delete t[r],t[o]=my(i),n[o]=!0})),this}concat(...e){return this.constructor.concat(this,...e)}toJSON(e){const t=Object.create(null);return Mm.forEach(this,((n,i)=>{null!=n&&!1!==n&&(t[i]=e&&Mm.isArray(n)?n.join(", "):n)})),t}[Symbol.iterator](){return Object.entries(this.toJSON())[Symbol.iterator]()}toString(){return Object.entries(this.toJSON()).map((([e,t])=>e+": "+t)).join("\n")}get[Symbol.toStringTag](){return"AxiosHeaders"}static from(e){return e instanceof this?e:new this(e)}static concat(e,...t){const n=new this(e);return t.forEach((e=>n.set(e))),n}static accessor(e){const t=(this[py]=this[py]={accessors:{}}).accessors,n=this.prototype;function i(e){const i=gy(e);t[i]||(!function(e,t){const n=Mm.toCamelCase(" "+t);["get","set","has"].forEach((i=>{Object.defineProperty(e,i+n,{value:function(e,n,r){return this[i].call(this,t,e,n,r)},configurable:!0})}))}(n,e),t[i]=!0)}return Mm.isArray(e)?e.forEach(i):i(e),this}}yy.accessor(["Content-Type","Content-Length","Accept","Accept-Encoding","User-Agent","Authorization"]),Mm.reduceDescriptors(yy.prototype,(({value:e},t)=>{let n=t[0].toUpperCase()+t.slice(1);return{get:()=>e,set(e){this[n]=e}}})),Mm.freezeMethods(yy);var vy=yy;function wy(e,t){const n=this||uy,i=t||n,r=vy.from(i.headers);let s=i.data;return Mm.forEach(e,(function(e){s=e.call(n,s,r.normalize(),t?t.status:void 0)})),r.normalize(),s}function by(e){return!(!e||!e.__CANCEL__)}function Ey(e,t,n){Hm.call(this,null==e?"canceled":e,Hm.ERR_CANCELED,t,n),this.name="CanceledError"}Mm.inherits(Ey,Hm,{__CANCEL__:!0});var Iy=Ey;function Ty(e,t,n){const i=n.config.validateStatus;n.status&&i&&!i(n.status)?t(new Hm("Request failed with status code "+n.status,[Hm.ERR_BAD_REQUEST,Hm.ERR_BAD_RESPONSE][Math.floor(n.status/100)-4],n.config,n.request,n)):e(n)}var Cy=ay.isStandardBrowserEnv?{write:function(e,t,n,i,r,s){const o=[];o.push(e+"="+encodeURIComponent(t)),Mm.isNumber(n)&&o.push("expires="+new Date(n).toGMTString()),Mm.isString(i)&&o.push("path="+i),Mm.isString(r)&&o.push("domain="+r),!0===s&&o.push("secure"),document.cookie=o.join("; ")},read:function(e){const t=document.cookie.match(new RegExp("(^|;\\s*)("+e+")=([^;]*)"));return t?decodeURIComponent(t[3]):null},remove:function(e){this.write(e,"",Date.now()-864e5)}}:{write:function(){},read:function(){return null},remove:function(){}};function Sy(e,t){return t?e.replace(/\/+$/,"")+"/"+t.replace(/^\/+/,""):e}function ky(e,t){return e&&!/^([a-z][a-z\d+\-.]*:)?\/\//i.test(t)?Sy(e,t):t}var Ry=ay.isStandardBrowserEnv?function(){const e=/(msie|trident)/i.test(navigator.userAgent),t=document.createElement("a");let n;function i(n){let i=n;return e&&(t.setAttribute("href",i),i=t.href),t.setAttribute("href",i),{href:t.href,protocol:t.protocol?t.protocol.replace(/:$/,""):"",host:t.host,search:t.search?t.search.replace(/^\?/,""):"",hash:t.hash?t.hash.replace(/^#/,""):"",hostname:t.hostname,port:t.port,pathname:"/"===t.pathname.charAt(0)?t.pathname:"/"+t.pathname}}return n=i(window.location.href),function(e){const t=Mm.isString(e)?i(e):e;return t.protocol===n.protocol&&t.host===n.host}}():function(){return!0};function Ay(e){const t=/^([-+\w]{1,25})(:?\/\/|:)/.exec(e);return t&&t[1]||""}var Ny=function(e,t){e=e||10;const n=new Array(e),i=new Array(e);let r,s=0,o=0;return t=void 0!==t?t:1e3,function(a){const c=Date.now(),l=i[o];r||(r=c),n[s]=a,i[s]=c;let h=o,u=0;for(;h!==s;)u+=n[h++],h%=e;if(s=(s+1)%e,s===o&&(o=(o+1)%e),c-r<t)return;const d=l&&c-l;return d?Math.round(1e3*u/d):void 0}};function Oy(e,t){let n=0;const i=Ny(50,250);return r=>{const s=r.loaded,o=r.lengthComputable?r.total:void 0,a=s-n,c=i(a);n=s;const l={loaded:s,total:o,progress:o?s/o:void 0,bytes:a,rate:c||void 0,estimated:c&&o&&s<=o?(o-s)/c:void 0,event:r};l[t?"download":"upload"]=!0,e(l)}}var Py="undefined"!=typeof XMLHttpRequest&&function(e){return new Promise((function(t,n){let i=e.data;const r=vy.from(e.headers).normalize(),s=e.responseType;let o;function a(){e.cancelToken&&e.cancelToken.unsubscribe(o),e.signal&&e.signal.removeEventListener("abort",o)}Mm.isFormData(i)&&(ay.isStandardBrowserEnv||ay.isStandardBrowserWebWorkerEnv?r.setContentType(!1):r.setContentType("multipart/form-data;",!1));let c=new XMLHttpRequest;if(e.auth){const t=e.auth.username||"",n=e.auth.password?unescape(encodeURIComponent(e.auth.password)):"";r.set("Authorization","Basic "+btoa(t+":"+n))}const l=ky(e.baseURL,e.url);function h(){if(!c)return;const i=vy.from("getAllResponseHeaders"in c&&c.getAllResponseHeaders());Ty((function(e){t(e),a()}),(function(e){n(e),a()}),{data:s&&"text"!==s&&"json"!==s?c.response:c.responseText,status:c.status,statusText:c.statusText,headers:i,config:e,request:c}),c=null}if(c.open(e.method.toUpperCase(),ry(l,e.params,e.paramsSerializer),!0),c.timeout=e.timeout,"onloadend"in c?c.onloadend=h:c.onreadystatechange=function(){c&&4===c.readyState&&(0!==c.status||c.responseURL&&0===c.responseURL.indexOf("file:"))&&setTimeout(h)},c.onabort=function(){c&&(n(new Hm("Request aborted",Hm.ECONNABORTED,e,c)),c=null)},c.onerror=function(){n(new Hm("Network Error",Hm.ERR_NETWORK,e,c)),c=null},c.ontimeout=function(){let t=e.timeout?"timeout of "+e.timeout+"ms exceeded":"timeout exceeded";const i=e.transitional||oy;e.timeoutErrorMessage&&(t=e.timeoutErrorMessage),n(new Hm(t,i.clarifyTimeoutError?Hm.ETIMEDOUT:Hm.ECONNABORTED,e,c)),c=null},ay.isStandardBrowserEnv){const t=(e.withCredentials||Ry(l))&&e.xsrfCookieName&&Cy.read(e.xsrfCookieName);t&&r.set(e.xsrfHeaderName,t)}void 0===i&&r.setContentType(null),"setRequestHeader"in c&&Mm.forEach(r.toJSON(),(function(e,t){c.setRequestHeader(t,e)})),Mm.isUndefined(e.withCredentials)||(c.withCredentials=!!e.withCredentials),s&&"json"!==s&&(c.responseType=e.responseType),"function"==typeof e.onDownloadProgress&&c.addEventListener("progress",Oy(e.onDownloadProgress,!0)),"function"==typeof e.onUploadProgress&&c.upload&&c.upload.addEventListener("progress",Oy(e.onUploadProgress)),(e.cancelToken||e.signal)&&(o=t=>{c&&(n(!t||t.type?new Iy(null,e,c):t),c.abort(),c=null)},e.cancelToken&&e.cancelToken.subscribe(o),e.signal&&(e.signal.aborted?o():e.signal.addEventListener("abort",o)));const u=Ay(l);u&&-1===ay.protocols.indexOf(u)?n(new Hm("Unsupported protocol "+u+":",Hm.ERR_BAD_REQUEST,e)):c.send(i||null)}))};const Ly={http:null,xhr:Py};Mm.forEach(Ly,((e,t)=>{if(e){try{Object.defineProperty(e,"name",{value:t})}catch(e){}Object.defineProperty(e,"adapterName",{value:t})}}));var Dy={getAdapter:e=>{e=Mm.isArray(e)?e:[e];const{length:t}=e;let n,i;for(let r=0;r<t&&(n=e[r],!(i=Mm.isString(n)?Ly[n.toLowerCase()]:n));r++);if(!i){if(!1===i)throw new Hm(`Adapter ${n} is not supported by the environment`,"ERR_NOT_SUPPORT");throw new Error(Mm.hasOwnProp(Ly,n)?`Adapter '${n}' is not available in the build`:`Unknown adapter '${n}'`)}if(!Mm.isFunction(i))throw new TypeError("adapter is not a function");return i},adapters:Ly};function xy(e){if(e.cancelToken&&e.cancelToken.throwIfRequested(),e.signal&&e.signal.aborted)throw new Iy(null,e)}function My(e){xy(e),e.headers=vy.from(e.headers),e.data=wy.call(e,e.transformRequest),-1!==["post","put","patch"].indexOf(e.method)&&e.headers.setContentType("application/x-www-form-urlencoded",!1);return Dy.getAdapter(e.adapter||uy.adapter)(e).then((function(t){return xy(e),t.data=wy.call(e,e.transformResponse,t),t.headers=vy.from(t.headers),t}),(function(t){return by(t)||(xy(e),t&&t.response&&(t.response.data=wy.call(e,e.transformResponse,t.response),t.response.headers=vy.from(t.response.headers))),Promise.reject(t)}))}const Uy=e=>e instanceof vy?e.toJSON():e;function Fy(e,t){t=t||{};const n={};function i(e,t,n){return Mm.isPlainObject(e)&&Mm.isPlainObject(t)?Mm.merge.call({caseless:n},e,t):Mm.isPlainObject(t)?Mm.merge({},t):Mm.isArray(t)?t.slice():t}function r(e,t,n){return Mm.isUndefined(t)?Mm.isUndefined(e)?void 0:i(void 0,e,n):i(e,t,n)}function s(e,t){if(!Mm.isUndefined(t))return i(void 0,t)}function o(e,t){return Mm.isUndefined(t)?Mm.isUndefined(e)?void 0:i(void 0,e):i(void 0,t)}function a(n,r,s){return s in t?i(n,r):s in e?i(void 0,n):void 0}const c={url:s,method:s,data:s,baseURL:o,transformRequest:o,transformResponse:o,paramsSerializer:o,timeout:o,timeoutMessage:o,withCredentials:o,adapter:o,responseType:o,xsrfCookieName:o,xsrfHeaderName:o,onUploadProgress:o,onDownloadProgress:o,decompress:o,maxContentLength:o,maxBodyLength:o,beforeRedirect:o,transport:o,httpAgent:o,httpsAgent:o,cancelToken:o,socketPath:o,responseEncoding:o,validateStatus:a,headers:(e,t)=>r(Uy(e),Uy(t),!0)};return Mm.forEach(Object.keys(Object.assign({},e,t)),(function(i){const s=c[i]||r,o=s(e[i],t[i],i);Mm.isUndefined(o)&&s!==a||(n[i]=o)})),n}const By={};["object","boolean","number","function","string","symbol"].forEach(((e,t)=>{By[e]=function(n){return typeof n===e||"a"+(t<1?"n ":" ")+e}}));const jy={};By.transitional=function(e,t,n){function i(e,t){return"[Axios v1.5.0] Transitional option '"+e+"'"+t+(n?". "+n:"")}return(n,r,s)=>{if(!1===e)throw new Hm(i(r," has been removed"+(t?" in "+t:"")),Hm.ERR_DEPRECATED);return t&&!jy[r]&&(jy[r]=!0,console.warn(i(r," has been deprecated since v"+t+" and will be removed in the near future"))),!e||e(n,r,s)}};var qy={assertOptions:function(e,t,n){if("object"!=typeof e)throw new Hm("options must be an object",Hm.ERR_BAD_OPTION_VALUE);const i=Object.keys(e);let r=i.length;for(;r-- >0;){const s=i[r],o=t[s];if(o){const t=e[s],n=void 0===t||o(t,s,e);if(!0!==n)throw new Hm("option "+s+" must be "+n,Hm.ERR_BAD_OPTION_VALUE)}else if(!0!==n)throw new Hm("Unknown option "+s,Hm.ERR_BAD_OPTION)}},validators:By};const Vy=qy.validators;class Hy{constructor(e){this.defaults=e,this.interceptors={request:new sy,response:new sy}}request(e,t){"string"==typeof e?(t=t||{}).url=e:t=e||{},t=Fy(this.defaults,t);const{transitional:n,paramsSerializer:i,headers:r}=t;void 0!==n&&qy.assertOptions(n,{silentJSONParsing:Vy.transitional(Vy.boolean),forcedJSONParsing:Vy.transitional(Vy.boolean),clarifyTimeoutError:Vy.transitional(Vy.boolean)},!1),null!=i&&(Mm.isFunction(i)?t.paramsSerializer={serialize:i}:qy.assertOptions(i,{encode:Vy.function,serialize:Vy.function},!0)),t.method=(t.method||this.defaults.method||"get").toLowerCase();let s=r&&Mm.merge(r.common,r[t.method]);r&&Mm.forEach(["delete","get","head","post","put","patch","common"],(e=>{delete r[e]})),t.headers=vy.concat(s,r);const o=[];let a=!0;this.interceptors.request.forEach((function(e){"function"==typeof e.runWhen&&!1===e.runWhen(t)||(a=a&&e.synchronous,o.unshift(e.fulfilled,e.rejected))}));const c=[];let l;this.interceptors.response.forEach((function(e){c.push(e.fulfilled,e.rejected)}));let h,u=0;if(!a){const e=[My.bind(this),void 0];for(e.unshift.apply(e,o),e.push.apply(e,c),h=e.length,l=Promise.resolve(t);u<h;)l=l.then(e[u++],e[u++]);return l}h=o.length;let d=t;for(u=0;u<h;){const e=o[u++],t=o[u++];try{d=e(d)}catch(e){t.call(this,e);break}}try{l=My.call(this,d)}catch(e){return Promise.reject(e)}for(u=0,h=c.length;u<h;)l=l.then(c[u++],c[u++]);return l}getUri(e){return ry(ky((e=Fy(this.defaults,e)).baseURL,e.url),e.params,e.paramsSerializer)}}Mm.forEach(["delete","get","head","options"],(function(e){Hy.prototype[e]=function(t,n){return this.request(Fy(n||{},{method:e,url:t,data:(n||{}).data}))}})),Mm.forEach(["post","put","patch"],(function(e){function t(t){return function(n,i,r){return this.request(Fy(r||{},{method:e,headers:t?{"Content-Type":"multipart/form-data"}:{},url:n,data:i}))}}Hy.prototype[e]=t(),Hy.prototype[e+"Form"]=t(!0)}));var $y=Hy;class zy{constructor(e){if("function"!=typeof e)throw new TypeError("executor must be a function.");let t;this.promise=new Promise((function(e){t=e}));const n=this;this.promise.then((e=>{if(!n._listeners)return;let t=n._listeners.length;for(;t-- >0;)n._listeners[t](e);n._listeners=null})),this.promise.then=e=>{let t;const i=new Promise((e=>{n.subscribe(e),t=e})).then(e);return i.cancel=function(){n.unsubscribe(t)},i},e((function(e,i,r){n.reason||(n.reason=new Iy(e,i,r),t(n.reason))}))}throwIfRequested(){if(this.reason)throw this.reason}subscribe(e){this.reason?e(this.reason):this._listeners?this._listeners.push(e):this._listeners=[e]}unsubscribe(e){if(!this._listeners)return;const t=this._listeners.indexOf(e);-1!==t&&this._listeners.splice(t,1)}static source(){let e;return{token:new zy((function(t){e=t})),cancel:e}}}var Wy=zy;const Ky={Continue:100,SwitchingProtocols:101,Processing:102,EarlyHints:103,Ok:200,Created:201,Accepted:202,NonAuthoritativeInformation:203,NoContent:204,ResetContent:205,PartialContent:206,MultiStatus:207,AlreadyReported:208,ImUsed:226,MultipleChoices:300,MovedPermanently:301,Found:302,SeeOther:303,NotModified:304,UseProxy:305,Unused:306,TemporaryRedirect:307,PermanentRedirect:308,BadRequest:400,Unauthorized:401,PaymentRequired:402,Forbidden:403,NotFound:404,MethodNotAllowed:405,NotAcceptable:406,ProxyAuthenticationRequired:407,RequestTimeout:408,Conflict:409,Gone:410,LengthRequired:411,PreconditionFailed:412,PayloadTooLarge:413,UriTooLong:414,UnsupportedMediaType:415,RangeNotSatisfiable:416,ExpectationFailed:417,ImATeapot:418,MisdirectedRequest:421,UnprocessableEntity:422,Locked:423,FailedDependency:424,TooEarly:425,UpgradeRequired:426,PreconditionRequired:428,TooManyRequests:429,RequestHeaderFieldsTooLarge:431,UnavailableForLegalReasons:451,InternalServerError:500,NotImplemented:501,BadGateway:502,ServiceUnavailable:503,GatewayTimeout:504,HttpVersionNotSupported:505,VariantAlsoNegotiates:506,InsufficientStorage:507,LoopDetected:508,NotExtended:510,NetworkAuthenticationRequired:511};Object.entries(Ky).forEach((([e,t])=>{Ky[t]=e}));var Gy=Ky;const Yy=function e(t){const n=new $y(t),i=rm($y.prototype.request,n);return Mm.extend(i,$y.prototype,n,{allOwnKeys:!0}),Mm.extend(i,n,null,{allOwnKeys:!0}),i.create=function(n){return e(Fy(t,n))},i}(uy);Yy.Axios=$y,Yy.CanceledError=Iy,Yy.CancelToken=Wy,Yy.isCancel=by,Yy.VERSION="1.5.0",Yy.toFormData=Q_,Yy.AxiosError=Hm,Yy.Cancel=Yy.CanceledError,Yy.all=function(e){return Promise.all(e)},Yy.spread=function(e){return function(t){return e.apply(null,t)}},Yy.isAxiosError=function(e){return Mm.isObject(e)&&!0===e.isAxiosError},Yy.mergeConfig=Fy,Yy.AxiosHeaders=vy,Yy.formToJSON=e=>ly(Mm.isHTMLForm(e)?new FormData(e):e),Yy.getAdapter=Dy.getAdapter,Yy.HttpStatusCode=Gy,Yy.default=Yy;var Jy=Yy;const{Axios:Xy,AxiosError:Qy,CanceledError:Zy,isCancel:ev,CancelToken:tv,VERSION:nv,all:iv,Cancel:rv,isAxiosError:sv,spread:ov,toFormData:av,AxiosHeaders:cv,HttpStatusCode:lv,formToJSON:hv,getAdapter:uv,mergeConfig:dv}=Jy,fv=Jy.create({baseURL:"https://api.themoviedb.org/3/"});class pv{constructor(){this.page=1,this.word="",this._movieId=null}async fetchMovies(){return(await fv.get(`/trending/movie/day?api_key=6de1479941bef67a0c224787b78603f1&page=${this.page}`)).data.results}async fetchMovieDetailsById(e){return(await fv.get(`movie/${e}?api_key=6de1479941bef67a0c224787b78603f1`)).data}async fetchMoviesByQuery(e,t){return(await fv.get(`/search/movie?api_key=6de1479941bef67a0c224787b78603f1&query=${e}&page=${t}`)).data.results}async fetchMoviesByPage(e){return(await fv.get(`/trending/movie/day?api_key=6de1479941bef67a0c224787b78603f1&page=${e}`)).data.results}async fetchGenresListByIds(){return(await fv.get("/genre/movie/list?api_key=6de1479941bef67a0c224787b78603f1&language=en")).data.genres}incrementPage(){this.page+=1}resetPage(){this.page=1}resetQuery(){this.word=""}get query(){return this.word}set query(e){return this.word=e}get movieId(){return this._movieId}set movieId(e){return this._movieId=e}}const gv=new pv;async function mv(){try{await gv.fetchMovies().then((e=>{console.log(e),Xg(e)}))}catch(e){console.log(e.message)}}async function _v(e,t){try{await gv.fetchMoviesByQuery(e,t).then((e=>{Xg(e)}))}catch(e){console.log(e.message)}}async function yv(e){try{await gv.fetchMovieDetailsById(e).then((e=>{Qg(e),Zg(e)}))}catch(e){console.log(e.message)}}async function vv(e){try{await gv.fetchMoviesByPage(e).then((e=>{Xg(e)}))}catch(e){console.log(e.message)}}async function wv(){try{Gg("genres",await gv.fetchGenresListByIds())}catch(e){console.log(e.message)}}function bv(){Kg.buttonLoadMore.classList.remove("not-visible")}async function Ev(e){em(),tm(e),await wv(),await mv(),bv()}async function Iv(){em(),Kg.homeBtn.classList.remove("nav_item--current"),Kg.libraryBtn.classList.add("nav_item--current"),Kg.headerNavButtons.classList.remove("not-visible"),Kg.form.classList.add("not-visible"),im("library"),bv()}function Tv(){em(),Kg.content.insertAdjacentHTML("beforeend",'\n   <img class="page-not-found"\n   src=""\n   alt=""\n />\n   '),Kg.buttonLoadMore.classList.add("not-visible")}Kg.loginButton.addEventListener("click",(async function(e){e.preventDefault();try{const e=Kg.txtEmail.value,t=Kg.txtPassword.value,n=await _p(Wg,e,t);console.log(n.user),Kg.signOut.classList.remove("not-visible"),Sv()}catch(e){console.log(e.message)}})),Kg.registerButton.addEventListener("click",(async function(){try{const e=Kg.regEmail.value,t=Kg.regPassword.value,n=await mp(Wg,e,t);console.log(n.user),Kg.signOut.classList.remove("not-visible"),Sv()}catch(e){console.log(e.message)}})),Kg.signOut.addEventListener("click",(async function(e){try{e.preventDefault(),window.location.assign("#/"),await(t=Wg,_e(t).signOut()),Kg.signOut.classList.add("not-visible"),console.log("user is successfully logout")}catch(e){console.log(e.message)}var t}));const Cv=Kg.formsAuth||[];function Sv(){for(let e=0;e<Cv.length;e++){const t=Cv[e];for(let e=0;e<t.elements.length;e++)"text"===t.elements[e].type&&(t.elements[e].value="")}}function kv(){const e=window.location.hash.substring(1),t=Wg.currentUser;console.log(e),"/"===e||""===e?Ev(t):"/library"===e?Iv():Tv()}(async()=>{var e,t,n;e=e=>{null!==e?(console.log("user logged in"),Kg.signOut.classList.remove("not-visible"),e.displayName,e.email,e.photoURL,e.emailVerified,e.uid):(Ev(e),console.log("no user"))},_e(Wg).onAuthStateChanged(e,t,n)})(),window.addEventListener("hashchange",kv),Kg.logo.addEventListener("click",Ev),kv();const Rv=new pv;let Av="",Nv=1;Kg.form.addEventListener("submit",(async function(e){if(e.preventDefault(),em(),Rv.resetPage(),Rv.query=e.currentTarget.elements.searchQuery.value.trim(),""===Rv.query)return;Nv=Rv.page,Av=Rv.query,await _v(Av,Nv),console.log("BEFORE scroll",Rv)})),Kg.buttonLoadMore.addEventListener("click",(async function(e){e.preventDefault(),console.log("BEFORE FETCH",Rv),Rv.incrementPage(),Nv=Rv.page,""===Av&&await vv(Nv);Av=Rv.query,await _v(Av,Nv),console.log("AFTER FETCH",Rv)}));const Ov=new pv;let Pv=[],Lv=[],Dv=null,xv="",Mv=[],Uv="";Kg.gallery.addEventListener("click",(async function(e){if(e.preventDefault(),"IMG"!==e.target.nodeName)return;return Dv=e.target.getAttribute("id"),Ov.movieId=Dv,console.log(Ov.movieId),await yv(Dv),Kg.modal.classList.add("open"),Kg.body.classList.add("lock"),Dv})),Kg.butttonsLibrary.addEventListener("click",(async function(e){if(e.preventDefault(),"BUTTON"!==e.target.nodeName)return;xv=e.target.getAttribute("id"),Pv=Yg(xv)||[],Lv=Yg(xv)||[],jv(e),await Ov.fetchMovieDetailsById(Ov.movieId).then((e=>{Mv=Yg("library")||[],console.log(e),Mv.push(e),Gg("library",Mv),"watched"===xv?(Pv.push(e),Gg(xv,Pv)):"queue"===xv&&(Lv.push(e),Gg(xv,Lv))})).catch((e=>console.log(e.message))).finally((()=>{alert("фільм додано в бібліотеку")}))})),Kg.buttonHeaderNav.addEventListener("click",(function(e){em(),xv=e.target.getAttribute("id"),Pv=Yg(xv)||[],Lv=Yg(xv)||[],"watched"===xv&&im(xv);"queue"===xv&&im(xv)})),Kg.libraryBtn.addEventListener("click",qv),Kg.registerLink.addEventListener("click",qv),Kg.loginLink.addEventListener("click",qv);const Fv=Kg.buttonClose;if(Fv)for(let e=0;e<Fv.length;e++)Fv[e].addEventListener("click",jv);const Bv=Kg.modalBackdrop;if(Bv)for(let e=0;e<Bv.length;e++)Bv[e].addEventListener("click",jv);function jv(e){Kg.modal.classList.remove("open"),"A"===e.target.nodeName&&e.target.closest(".modal").classList.remove("open"),Kg.body.classList.remove("lock"),Kg.movieImage.innerHTML="",Kg.movieDescr.innerHTML="",e.preventDefault()}function qv(e){e.preventDefault();const t=Wg.currentUser;if(Uv=e.target.getAttribute("id"),"library_btn"===Uv&&t)return window.location.assign("#/library"),void Kg.modalRegister.classList.remove("open");"library_btn"!==Uv||t?(Kg.modalRegister.classList.toggle("open"),Kg.modalLogin.classList.toggle("open")):Kg.modalLogin.classList.add("open")}
//# sourceMappingURL=index.e1d35f84.js.map
